...
#lblcantype,#canceltypeDropDownList,#lblcanvg,#canvgDropDownList,#lblcanreason,#canreasonDropDownList,#lblcancomment,#cancommentTextBox
{
    display:none;
}
</style>
           ...
           <br />
            ...
            <table style="width:100%;">
               ...
               <tr>
                ...
                <tr>
                 <td><asp:Label ID="lblcantype" runat="server"  Font-Size="Medium" Text="Select Cancel Type"></asp:Label></td>
                <td><asp:DropDownList ID="canceltypeDropDownList" style="width:200px;  height:25px" Font-Size="Small"  runat="server"></asp:DropDownList></td>

                 <td><asp:Label ID="lblcanvg" runat="server"  Font-Size="Medium" Text="Select Cancel Venue Group"></asp:Label></td>
                <td><asp:DropDownList ID="canvgDropDownList" style="width:200px;  height:25px" Font-Size="Small"  runat="server"></asp:DropDownList></td>

                 <td><asp:Label ID="lblcanreason" runat="server" Font-Size="Medium" Text="Label">Cancel Reason</asp:Label></td>
               <td><asp:DropDownList ID="canreasonDropDownList" style="width:200px;  height:25px" Font-Size="Small"  runat="server"></asp:DropDownList></td>
 
                <td><asp:Label ID="lblcancomment" runat="server" Font-Size="Medium" Text="Label">Cancel Comment</asp:Label></td>
                <td><asp:TextBox ID="cancommentTextBox" Font-Size="Small" style="width:200px; height:20px" runat="server" Enabled="True" TextMode="MultiLine"></asp:TextBox></td>
                ...
                <td><asp:TextBox ID="ContractdetailsIDTextBox" Font-Size="Small" style="width:200px; height:20px" runat="server" Enabled="True"  ></asp:TextBox></td>
                    ...
                    <tr>
                        <td></td><td></td><td></td>
                         <td width="100px" align="center"><asp:Button ID="Button2" runat="server" Text="Update Deal Status" Visible="False" /></td>
                    </tr>
   ...
   $(document).ready(function () {
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#dealstatusDropDownList").change(function ()
            {
                var value = $("#dealstatusDropDownList option:selected").text();
                if (value == "Cancel" || value == "Cancelled" || value == "CANCELLED" || value=="CANCEL")
                {
                    $("#lblcantype").show();
                    $("#canceltypeDropDownList").show();
                    $("#lblcanvg").show();
                    $("#canvgDropDownList").show();
                    $("#lblcanreason").show();
                    $("#canreasonDropDownList").show();
                    $("#lblcancomment").show();
                    $("#cancommentTextBox").show();
                }
                else  
                {
                    $("#lblcantype").hide();
                    $("#canceltypeDropDownList").hide();
                    $("#lblcanvg").hide();
                    $("#canvgDropDownList").hide();
                    $("#lblcanreason").hide();
                    $("#canreasonDropDownList").hide();
                    $("#lblcancomment").hide();
                    $("#cancommentTextBox").hide();
