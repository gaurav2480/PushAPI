...
document.getElementById('Button6').click();
  ...
  $(function () {
      ...
      $("#datepicker5,#datepicker6,#TextBoxCoolStart,#TextBoxCoolEnd").datepicker({
          changeMonth: true,
          changeYear: true,
          yearRange: "1950:2050",
          dateFormat: 'dd-mm-yy',
...
//                   FinanceCurrencyDropDownList

                   var v0 = document.getElementById("FinanceCurrencyDropDownList");
                   var curr = v0.options[v0.selectedIndex].text;
                  ...
                  // alert(ugdg);
                   ...
                   var v4,v5;
                   var club = "", resort1 = "", resort = "",coolonoff="";
                       ...
                       if (dealstat == 'Deal' || dealstat == 'Top Drawer'){
                          ...
                          // alert(ven+'  '+venue+'  '+conttype);
                           ...
                           if (conttype == 'Points') {
                               ...
                               resort = "";
                               coolonoff = document.getElementById("TextBoxDummyConoffcheck").value;
                           } 
                          else if (conttype == 'Trade Into Points')
                           {
                          ...
                          if (dealstat == 'Top Drawer')
                           {
                              if (conttype == 'Points' || conttype == 'Fractional' || conttype == "Trade Into Points" || conttype == 'Trade Into Fractional') {
                                  // alert('into top drawer');
                                   document.getElementById("pbala").style.display = 'grid';
                                   document.getElementById("pbalaTD").style.display = 'grid';
                               }
                                   /*c9*//*                  else if (conttype == 'Fractional') {
                          ...
                          // alert('kkk');
                           $.ajax({
                               ...
                               data: "{'name': '" + ven + "','venue': '" + venue + "','club': '" + club + "','mark': '" + mark + "','conttype': '" + conttype + "','markp': '" + markp + "','resort': '" + resort + "','curr': '" + curr + "','coolonoff': '" + coolonoff + "'}",
                               dataType: "json",
                               //called on jquery ajax call success
                               success: function (data) {
                                   // alert(data.d);
...
///for property fees
               ...
               $("#GroupVenueDropDownList").change(function () {
		        ...
		        if (id == "Inhouse" || id == "INHOUSE") {
                   ...
                   */
                   ...
                   // alert(id + "   " + id2);
                    ...
                    if (id == "Flybuy" || id == "FLYBUY") {
                       ...
                       $.ajax({
                           ...
                           contentType: "application/json; charset=utf-8",
                           //url is the path of our web method (Page name/function name)
                           url: "contracts.aspx/PopulateFlyTeleDropDownList",
                           data: "{'countid' : '" + id2 + "'}",
                           dataType: "json",
                           //called on jquery ajax call success
                           success: function (data) {
                       ...
                       $.ajax({
                           ...
                           contentType: "application/json; charset=utf-8",
                           //url is the path of our web method (Page name/function name)
                           url: "contracts.aspx/PopulateFlyPreArivDropDownList",
                           data: "{'countid' : '" + id2 + "'}",
                           dataType: "json",
                           //called on jquery ajax call success
                           success: function (data) {
                       ...
                       $.ajax({
                           ...
                           contentType: "application/json; charset=utf-8",
                           //url is the path of our web method (Page name/function name)
                           url: "contracts.aspx/PopulateFlyVerifiDropDownList",
                           data: "{'countid' : '" + id2 + "'}",
                           dataType: "json",
                           //called on jquery ajax call success
                           success: function (data) {
                   ...
                   else if (id == "Inhouse" || id == "INHOUSE") {
                       document.getElementById("item9b").style.display = "none";
                       document.getElementById("item9").style.display = "grid";
                       document.getElementById("itemFly").style.display = "none";

                   document.getElementById("gueststatusDropDownList").selectedIndex = "5";
                   loadQStatus();
                   document.getElementById("QStatusDropDownList1").selectedIndex = "2";
           ...
           $(document).ready(function () {
               $("#MarketingPrgmDropDownList").change(function () {
                   ...
                   var v4 = document.getElementById("VenueDropDownList");
                   var id4 = v4.options[v4.selectedIndex].text;

                   //var id4 = $("#VenueDropDownList option:selected").text();
                   ...
                   $.ajax({
                       ...
                       data: "{'markid': '" + id + "','venueid': '" + id4 + "','countid': '" + id3 + "'}",
                       dataType: "json",
                       //called on jquery ajax call success
                       success: function (data) {
...
function showinhouse() {
    //  var v1 = document.getElementById("VenueDropDownList");   GroupVenueDropDownList
    var v1 = document.getElementById("GroupVenueDropDownList");
                var id = v1.options[v1.selectedIndex].text;
		    ...
		    function curr2(Currtype1)
{
	   ...
	   /*for ice*/
		...
		var globcurr;/*global currency*/
           ...
           function CurrencyFees()
           {
               ...
               if (Currtype == 'INR')
               {
                   var result = "Contract Currency : " + Currtype +"  &  " + "MC Currency: INR";
                   ...
                   document.getElementById("Label42").innerHTML = result;
                   document.getElementById("Label42").style.color = "Red";
                   document.getElementById("Label42").style.fontStyle = "Bold";
                   document.getElementById("Label42").style.fontStyle = "Italic";
                   document.getElementById("Label42").style.fontSize = "Medium";

                   document.getElementById("Label43").innerHTML = result;
                   document.getElementById("Label43").style.color = "Red";
                   document.getElementById("Label43").style.fontStyle = "Bold";
                   document.getElementById("Label43").style.fontStyle = "Italic";
                   document.getElementById("Label43").style.fontSize = "Medium";
               }
               else
               {
                   var result = "Contract Currency : " + Currtype + "  &  " + "MC Currency : USD";
                   document.getElementById("lblfcurr").innerHTML = result;
                   document.getElementById("lblfcurr").style.color = "Red";
                   document.getElementById("lblfcurr").style.fontStyle = "Bold";
                   document.getElementById("lblfcurr").style.fontStyle = "Italic";
		...
		document.getElementById('item92').style.display = 'none';
                   ...
                   $.ajax({
                       ...
                       contentType: "application/json; charset=utf-8",
                       //url is the path of our web method (Page name/function name)
                       url: "contracts.aspx/PopulateBalancePayMethod",
		...
		if(document.getElementById("ca1").checked == false)
		{document.getElementById("ca1").checked = true;

		document.getElementById('item92').style.display = 'grid';
		}
	...
	function COcheck()
           {
               //var checkCO = document.getElementById('TextBoxCoolStart').value;

               var v1 = document.getElementById("ContractVenueVPDropDownList");
               var checkCO = v1.options[v1.selectedIndex].text;

               if (checkCO.match(/CO-/gi))
               {
...
coolonoff();
		...
		document.getElementById("coolonoff1").checked = false;
coolonoff();
               }
           }
		   ...
		   function TFadminfeesErate(t1) {
               // alert('TFadminfees');
               var v1 = document.getElementById("ContTypeDropDownListTF");
               var conttype = v1.options[v1.selectedIndex].text;
               // alert(conttype);
               if (conttype == "From Points To Fractional") {
                   document.getElementById("TextAdminFees").value = Math.round(parseFloat(t1) * 1500); 
               }
               else if (conttype == "From Weeks To Fractional") {
                   document.getElementById("TextAdminFees").value = Math.round(parseFloat(t1) * 1500); 
               }
               else if (conttype == "From Fractional To Fractional") {
                   document.getElementById("TextAdminFees").value = Math.round(parseFloat(t1) * 750); 
               }
               //CurrencyFees();
           }
               ...
               if(conttype == "Fractional")
               {
                //   alert("Fractional");
                  // TextFOccuF
                   ...
                   document.getElementById("TextFOccuF").value = '2019';
...
document.getElementById("ca1").checked = true;
               ...
               else if (conttype == "Points")
               {
                  // alert('hi2');
                   ...
                   document.getElementById("item202a2").style.display = "none";
                   document.getElementById("item202b2").style.display = "none";
                   document.getElementById("TextPFOccu").value = '2019';
			...
			document.getElementById("ca1").checked = true;
                   ...
                   else if (doffice == "VTM" )
                   {
                       ...
                       document.getElementById('remarkpp4').style.display = "none";
                       globO = '1';
                      // document.getElementById("TextBoxDummyOverride").value = "1";
                   }
			...
			document.getElementById("ca1").checked = true;
                   ...
                   document.getElementById("TextFYOccuTF").value = '2019';
			...
			document.getElementById("ca1").checked = true;
                   ...
                   document.getElementById("TextFYOccTP").value = '2019';
   ...
   // text13 += reF(glob);//document.getElementById("textBox_" + e + "1").value + " " + document.getElementById("textBox_" + e + "4").value + " " + document.getElementById("textBox_" + e + "2").value + " on " + document.getElementById("textBox_" + e + "3").value + " By Crown Finance LTD. " + document.getElementById("TextContractNumb").value + "/" + document.getElementById("TextPnumb").value + ";";
    ...
    for (e = 1; e <= glob; e++) {   //alert("hi"+e); 
        ...
        if (e == glob) {
            ...
            {
                text13 += document.getElementById("textBox_" + e + "1").value + " " + document.getElementById("textBox_" + e + "4").value + " " + document.getElementById("textBox_" + e + "2").value + " ON VIDE FINANCE AGREEMENT NO. " /*+ document.getElementById("textBox_" + e + "3").value + " By Parshuram Finance "*/ + document.getElementById("TextPnumb").value + ";";
            }
            else {
              ...
              //  alert("value of text" + parseInt(document.getElementById("textBox_" + pe + "2").value.replace(/,/g, '')) + "   " + (parseInt(balancepa) - parseInt(pre)));
                ...
                if (parseInt(document.getElementById("textBox_" + pe + "2").value.replace(/,/g, '')) <= (parseInt(balancepa) - parseInt(pre))) {
                 ...
                 //   alert("te  "+ te1);
                    ...
                    //    alert("testyes");
                    //    alert(parseInt(te1));
                    //    alert("with commas "+addCommas(parseInt(te1)));
                ...
                for (e = 1; e <= glob; e++) {   //alert("hi"+e); 
                    ...
                    if (e == glob) {
                        ...
                        else if(paym=="PARSHURAM FINANCE")
                        {
                            ...
                            if (document.getElementById("textBoxN_" + e + "2").value != 0) {
                                text13 += document.getElementById("textBoxN_" + e + "1").value + " " + document.getElementById("textBox_" + e + "4").value + " " + document.getElementById("textBox_" + e + "2").value + " ON VIDE FINANCE AGREEMENT NO. " /*+ document.getElementById("textBox_" + e + "3").value + " By Parshuram Finance "*/ + document.getElementById("TextPnumb").value + ";";
                                // text15 += document.getElementById("textBox_" + e + "4").value + " " + document.getElementById("textBox_" + e + "2").value + " on " + document.getElementById("textBox_" + e + "3").value + " By Crown Finance LTD. " + document.getElementById("TextContractNumb").value + "/" + document.getElementById("TextPnumb").value + ";";
                                // alert(text13);
                                //var br = document.createElement('br');
                                //TextPBalanceDDates.appendChild(br);
       ...
       // alert('2');
            ...
            function val3()
           {
              // alert('enter val3')
               ...
               /*c5*/       <%--  document.getElementById('<%= TextDueDatesPAF.ClientID %>').style.backgroundColor = '#ffffff';
 ...
 /*c5*/              else if (id == 'Fractional')
        ...
        if (id == 'Points')
        {
           ...
           function check_load_Ibalance()
           {
               ...
               /*c4*/     /*  var depof = parseInt(document.getElementById("TextDepositF").value);
       ...
       /*c4*/       /* else if (dropval == "Trade Into Points") {
         ...
         /*c3*/      /*else if (dropval == "Fractional")
           ...
           {
               // var n = document.getElementById("GroupVenueDropDownList"); VenueDropDownList
               var n = document.getElementById("VenueDropDownList");
               ...
               $.ajax({
                   ...
                   contentType: "application/json; charset=utf-8",
                   //url is the path of our web method (Page name/function name)
                   url: "contracts.aspx/pnumberCountINR",
                   data: "{'id': '" + id + "'}",
                   dataType: "json",
                   //called on jquery ajax call success
                   success: function (data) {
          ...
          function cardremark(card, comment)
           {
              ...
              var v2 = document.getElementById("FinanceCurrencyDropDownList");
              var curr = v2.options[v2.selectedIndex].text;
             // alert('depo  ' + depomet + '   ' + dropval+'    '+curr);
              ...
              else
              {
               ...
               //  alert('hi cardremark2');
                  //var curr = $(FinanceCurrencyDropDownList).val();
                  //alert(curr);
                  if (dropval == "Points" || dropval == "Fractional" || dropval == "Trade Into Points" || dropval == "Trade Into Fractional") {
                  //    alert('hi cardremark3');
          ...
          function INRadmin()
         {
             ...
             var conttype = v2.options[v2.selectedIndex].text;
              ...
              // var v3 = document.getElementById("VenueDropDownList"); GroupVenueDropDownList
          ...
          function fullcash()
          {
              ...
              if (fina == "Full Cash")
              {
                ...
                date = new Date();
                       ...
                       document.getElementById("datepicker8").value = dt + '-' + month + '-' + year;
        ...
        /*c1*/        /*  else if(drop == "Trade Into Fractional")
                  {
          ...
          function reSAPA(noofInstall,cf) {
              ...
              else if (cf == "CF")
              {
                  ...
                  if (document.getElementById("textBoxN_" + glob + "2").value != 0) {
                      ...
                      {
                          re = re + ', ' + document.getElementById("textBox_" + glob + "4").value + " " + document.getElementById("textBoxN_" + glob + "2").value + " ON VIDE FINANCE AGREEMENT NO. "/* + document.getElementById("textBox_" + glob + "3").value + " By Parshuram Finance " */+ document.getElementById("TextPnumb").value + ";";
                      }
                  }
                  else
                  {
          ...
          function reF(noofInstall) {
              ...
              {
                  re2 = re + document.getElementById("textBox_" + noofInstall + "4").value + " " + document.getElementById("textBox_" + noofInstall + "2").value + " ON VIDE FINANCE AGREEMENT NO. "/* + document.getElementById("textBox_" + noofInstall + "3").value + " By Parshuram Finance " */+ document.getElementById("TextPnumb").value + ";";
              }
              //re = balamddate + re;
              // var re1 = balamddate + re;
...
#myBtnBack:hover {
  background-color: #555;
   ...
   #cleft {
     ...
     #TextBoxDummyTax,#TextBoxDummyRate,#TextBoxDummyOffice,#TextBoxDummyOverride,#TextBoxDummyCDSRDate,#TextBoxDummyConoffcheck,#TextBoxDummyleaseoff{
         /*float:left;*/
         display:none;
     }
     
      /*for cont type*/
      #table1,#table2,#tableTF1,#tableTF2,#tableTF3,#Buttonover{
          display:none;
      }


      #tPurchase,#QDepo,#AmtCre,#CreCurr,#NoOfMonth,#RateOfInt,#MonthlyRepay,#fbala,#FbalaTD,#tpbala,#TpbalaTD,#tfbala,#TFbalaTD,#F50,#P50,#TF50,#TP50,#cpacom,#Button9,#Button13,#Button7,#Button12,#Button10,#tButton1,#Button11,#Button14,
...
.grid-PFinaContainer{
    ...
    /*grid-template-rows: auto auto;  --comment
    grid-gap: 5px;
...
<asp:Label ID="lblfcurr" runat="server"></asp:Label>
          ...
          <asp:DropDownList ID="DropDownList40" runat="server"  Width="200px" style="height: 25px" onchange="contracttype();document.getElementById('item92').style.display = 'grid';CurrencyFees();">
          ...
          <!--  <p>Affiliate Type</p>
           <input id="ca1" type="checkbox" onclick="addvalue1();" checked="checked" /><asp:Label ID="Label80" runat="server" Text="Label">ICE</asp:Label>
                   <br />-->
                   <input type="button" name="UPDOButton" id="UPDOButton" value="Upgrade/Downgrade" onclick="btnclickUG();"  style="background-color:#555;color: white;height:30px;width:200px;margin-top:15px;border:none;">
          ...
          <asp:DropDownList ID="ButtonUpDropDownList" runat="server" style="height: 25px" Width="200px"></asp:DropDownList>
           ...
           <asp:DropDownList ID="FinanceCurrencyDropDownList" onchange="CurrencyFees();" style="height: 25px" runat="server" Width="200px"></asp:DropDownList>
               ...
               <div id="item98">
                  <p> </p>
                   <input id="coolonoff1" type="checkbox" onclick="coolonoff();" /><asp:Label ID="Label47" runat="server" Text="Label">COOLING OFF</asp:Label>
...
<asp:Label ID="Label42" runat="server"></asp:Label> 
        ...
        <div class="padminp">
            ...
            <div class="padminp4"><asp:TextBox ID="TextAdminFees" runat="server" Enabled="True" onchange="pp('TextAdminFees');"></asp:TextBox></div>
             ...
             <div class="padminp3a" style="width:300px"><asp:Label ID="Label49" runat="server" Text="Label">Affiliate Type</asp:Label></div>
            <div class="padminp4a"> <input id="ca1" type="checkbox" onclick="addvalue1();" checked="checked" /><asp:Label ID="Label48" runat="server" Text="Label">ICE</asp:Label></div>
        ...
        <div id="pPA">
           ...
           <div id="pPA2">
               ...
               <div id="pPA2p17">
                   <asp:Label ID="Label30" runat="server" Text="Label">CGST</asp:Label>
                   </div>
               <div id="pPA2p18">
                   <asp:TextBox ID="TextBoxCGST" runat="server" Enabled="True" Width="100px"></asp:TextBox>
                   </div>
               <div id="pPA2p19">
                   <asp:Label ID="Label46" runat="server" Text="Label">SGST</asp:Label>
                   </div>
               <div id="pPA2p20">
