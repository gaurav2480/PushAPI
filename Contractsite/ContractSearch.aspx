<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ContractSearch.aspx.cs" Inherits="Contractsite_test2" %>
...
<body>
    ...
    <div>
        ...
        <br />
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="true" CssClass="grid" Width="100%" OnRowCommand="GridView1_RowCommand"  >
            <Columns>
