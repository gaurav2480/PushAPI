...
.has-search .form-control {
    ...
    padding-left: 34px;
     ...
     .title{
      ...
      #update,#toManagerID,#head,#toManagerName,#Office,#managerstatus,#directory,#insert,#Venue,#vCountry,#description,#Manager,#VP_ID{
          display:none;
      }
      #TextBox5{
          text-align:center;
            ...
            $("#insert").click(function () {
              ...
              //  var status = $("#status").val();
                ...
                $.ajax({
                    ...
                    data: "{'tomanagername':'" + toManagerName + "','tomanageroffice':'" + toManagerOffice + "','venueCountryID':'" + venueCountryID + "','venue':'" + venue + "','description':'" + description + "','venueCountryName':'" + venueCountryName + "','manager':'" + manager + "','vpID':'" + vpID + "'}",
                    async: false,
                           ...
                           // alert(data.d);
                            ...
                            $.each(subJson, function (key, value) {
                                ...
                                $.each(value, function (index1, value1) {
                                    ...
                                    $("#task-table tbody").append("<tr><td>" + value1[0] + "</td><td>" + value1[1] + "</td><td>" + value1[7] + "</td><td>" + value1[9] + "</td><td>" + value1[2] + "</td><td>" + value1[3] + "</td><td style='display:none;'>" + value1[4] + "</td><td>" + value1[5] + "</td><td>" + value1[6] + "</td><td>" + value1[10] + "</td><td><button type='button'  class='edit-btn btn btn-primary col-md-12' >Edit</button></td><td><button type='button'  class='delete-btn btn btn-primary col-md-12' >Delete</button></td></tr>");
            ...
            $(document).ready(function () {
                $("#update").click(function () {
                    ...
                    $.ajax({
                        ...
                        contentType: "application/json; charset=utf-8",
                        data: "{'toManagerID':'" + toManagerID + "','toManagername':'" + toManagerName + "','office':'" + office + "','toManagerstatus':'" + toManagerStatus + "','venue':'" + venue + "','venuecountry':'" + venuecountry + "','description':'" + description + "','manager':'" + manager + "','vpID':'" + vpID + "'}",
                        async: false,
                        success: function (data) {
                            $("#TextBox1").val("");
                            $("#TextBox2").val("");
