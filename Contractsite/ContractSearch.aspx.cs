...
{
    static string pname, office,user,name,  ContractdetailsID;
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        //  ContractdetailsID = dsct.Tables[0].Rows[0]["ContractDetails_ID"].ToString();
  
        //Session["ContractdetailsID"] = ContractdetailsID;
    ...
    protected void LinkbtnClick(object sender, EventArgs e)
    {
        if (office == "HML")
        {
            ...
            else if (pname == "EditContract")
            {
                ...
                DataSet dsct = Queries.LoadContractNoDetails(((LinkButton)sender).Text);
                ContractdetailsID = dsct.Tables[0].Rows[0]["ContractDetails_ID"].ToString();
                Session["ContractdetailsID"] = ContractdetailsID;
