...
reader2.Close();
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        string venueGroupIndia = TextBox2.Text;
        string group = Request.Form["group"];

        this.Page.ClientScript.RegisterStartupScript(this.GetType(), "Warning", "pele('" + TextBox1.Text + "','" + country + "','"+venue+ "','" + venueGroupIndia + "','" + group + "')", true);
