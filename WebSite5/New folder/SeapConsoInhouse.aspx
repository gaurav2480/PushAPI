...
.has-search .form-control {
  ...
  display: block;
    ...
    <script src="https://ajax.aspnetcdn.com/ajax/jQuery/jquery-3.2.1.min.js"></script>
        ...
        function pele(date,country,venue,group) {

            var name = "SEAP. CONSOLIDATE RECAP IN-HOUSE TS";
            var url = "reportViewer.aspx?name=" + name + "&date=" + date + "&country=" + country + "&venue=" + venue + "&group=" + group + "";
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 " id="head">
                                <br />
                                <h4 class="text-center">CONSOLIDATE RECAP IN-HOUSE TS & FRACTIONAL</h4>
                            </div>
                        </div>
                    </div>
                    <br />
	...
	<script>
		$(document).ready(function () {
			var country = $("#country option:selected").text();
                if (country == "INDONESIA" || country == "THAILAND" || country == "VIETNAM") {
                ...
                $(document).on('keypress', '#searchReports', function (event) {
                    ...
                    if (keycode == '13') {
                        ...
                        $.ajax({
                            ...
                            type: 'Post',
                            url: 'SeapConsoInhouse.aspx/searchReports',
                            contentType: "application/json; charset=utf-8",
                            data: "{'val':'" + val + "'}",
                            async: false,
                            success: function (data) {
                ...
                $(document).on('keypress', '#searchReports1', function (event) {
                    ...
                    if (keycode == '13') {
                        ...
                        $.ajax({
                            ...
                            type: 'Post',
                            url: 'SeapConsoInhouse.aspx/searchReports1',
                            contentType: "application/json; charset=utf-8",
                            data: "{'val':'" + val + "'}",
                            async: false,
                            success: function (data) {
