    ...
    padding-left: 34px;
      ...
      font-style:oblique;
        ...
        #img {
         ...
         #update,#directory,#insert,#Groups,#VenueGroup{
             display:none;
         }
  ...
  display: block;
    ...
    <script src="https://ajax.aspnetcdn.com/ajax/jQuery/jquery-3.2.1.min.js"></script>
     ...
     <script type="text/javascript">
         ...
         function pele(date, country, venue, venueGroupIndia, group) {

            var name = "SEAP. CONSOLIDATED RECAP IN-HOUSE";
            var url = "reportViewer.aspx?name=" + name + "&date=" + date + "&country=" + country + "&venue=" + venue + "&venueGroupIndia=" + venueGroupIndia + "&group=" + group + "";
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 " id="head">
                                <br />
                                <h4 class="text-center">CONSOLIDATED RECAP IN-HOUSE</h4>
                            </div>
                        </div>
                    </div>
                    <br />
       ...
       <script>
		   ...
		   $(document).ready(function () {
			   ...
			   var country = $("#country option:selected").text();
                ...
                } else if(country=="INDONESIA"|| country=="THAILAND" || country=="VIETNAM") {
                    $("#Groups").hide();
                    $("#VenueGroup").hide();
                ...
                $(document).on('keypress', '#searchReports', function (event) {
                    ...
                    if (keycode == '13') {
                        ...
                        $.ajax({
                            ...
                            type: 'Post',
                            url: 'SeapConsoRecapInhouse.aspx/searchReports',
                            contentType: "application/json; charset=utf-8",
                            data: "{'val':'" + val + "'}",
                            async: false,
                            success: function (data) {
                ...
                $(document).on('keypress', '#searchReports1', function (event) {
                    ...
                    if (keycode == '13') {
                        ...
                        $.ajax({
                            ...
                            type: 'Post',
                            url: 'SeapConsoRecapInhouse.aspx/searchReports1',
                            contentType: "application/json; charset=utf-8",
                            data: "{'val':'" + val + "'}",
                            async: false,
                            success: function (data) {
