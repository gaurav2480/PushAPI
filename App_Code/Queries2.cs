...
public class Queries2
{
    ...
    {
        // Get the connection string from the configuration file
        string connectionString = ConfigurationManager.ConnectionStrings["DBConnectionString2"].ConnectionString;
    ...
    /*public static DataSet LoadVenueCountry1(string office1)
       {
           SqlDataAdapter da;
           DataSet ds = new DataSet();
           using (SqlConnection cs1 = Queries.GetDBConnection())
           {
               SqlCommand SqlCmd = new SqlCommand("select Venue_Country_Name  from VenueCountry where Venue_Country_Status = 'Active' and Venue_Country_Office in("+office1.TrimEnd(',')+")", cs1);
               da = new SqlDataAdapter(SqlCmd);
               ds = new DataSet();
               da.Fill(ds);
           }
    ...
    public static DataSet LoadPayMethod()
    {
        ...
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            SqlCommand SqlCmd = new SqlCommand("select distinct pay_method_name from pay_method where currency<>'INR'", cs1);
            //SqlCmd.Parameters.Add("@office", SqlDbType.VarChar).Value = office;
    ...
    public static DataSet LoadPayMethod2(string Currtype)
    {
        SqlDataAdapter da;
        DataSet ds = new DataSet();
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            SqlCommand SqlCmd = new SqlCommand("select pay_method_name from pay_method where currency='" + Currtype + "'", cs1);
            //SqlCmd.Parameters.Add("@office", SqlDbType.VarChar).Value = office;
    ...
    public static DataSet LoadSalesReps(string venuecountry, string venue, string GroupVenueDropDownList)
    {
        ...
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            if (GroupVenueDropDownList == "Inhouse" || GroupVenueDropDownList == "INHOUSE")
            {
                SqlCommand SqlCmd = new SqlCommand("select Sales_Rep_Name  from Sales_Rep where Venue_country_ID=@venuecountry  and Group_venue = '' and Sales_Rep_Status='Active'", cs1);//("select * from Sales_Rep where Venue_country_ID in (select Venue_Country_ID from VenueCountry where Venue_Country_Name=@venuec)", cs1);
                SqlCmd.Parameters.Add("@venuecountry", SqlDbType.VarChar).Value = venuecountry;
            ...
            else if (GroupVenueDropDownList == "Flybuy" || GroupVenueDropDownList == "FLYBUY")
            {
                SqlCommand SqlCmd = new SqlCommand("select Sales_Rep_Name  from Sales_Rep where Venue_country_ID=@venuecountry and Sales_Rep_Status='Active'", cs1);//("select * from Sales_Rep where Venue_country_ID in (select Venue_Country_ID from VenueCountry where Venue_Country_Name=@venuec)", cs1);
                SqlCmd.Parameters.Add("@venuecountry", SqlDbType.VarChar).Value = venuecountry;
            ...
            else if (GroupVenueDropDownList == "Coldline" || GroupVenueDropDownList == "COLDLINE")
            {

                SqlCommand SqlCmd = new SqlCommand("select Sales_Rep_Name  from Sales_Rep where Venue_country_ID=@venuecountry and venue= @venue and Group_venue=@gvenue and Sales_Rep_Status='Active'", cs1);//("select * from Sales_Rep where Venue_country_ID in (select Venue_Country_ID from VenueCountry where Venue_Country_Name=@venuec)", cs1);
                SqlCmd.Parameters.Add("@venuecountry", SqlDbType.VarChar).Value = venuecountry;
                SqlCmd.Parameters.Add("@venue", SqlDbType.VarChar).Value = venue;
    ...
    public static DataSet LoadTOManager(string office, string venue, string venuecountry, string GroupVenueDropDownList)
    {
        ...
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            if (GroupVenueDropDownList == "Inhouse" || GroupVenueDropDownList == "INHOUSE")
            {
                SqlCommand SqlCmd = new SqlCommand("select distinct TO_Manager_name from TO_manager where office=@office and (Group_Venue='"+ GroupVenueDropDownList + "' or Group_Venue='') and TO_Manager_Status ='Active' and VenueCountry_ID=@venuecountry order by 1", cs1);
                SqlCmd.Parameters.Add("@office", SqlDbType.VarChar).Value = office;
                SqlCmd.Parameters.Add("@venue", SqlDbType.VarChar).Value = venue;
                SqlCmd.Parameters.Add("@venuecountry", SqlDbType.VarChar).Value = venuecountry;
                da = new SqlDataAdapter(SqlCmd);
            ...
            {
                SqlCommand SqlCmd = new SqlCommand("select distinct TO_Manager_name from TO_manager where office=@office and Group_Venue='" + GroupVenueDropDownList + "'  and TO_Manager_Status ='Active' and VenueCountry_ID=@venuecountry order by 1", cs1);
                SqlCmd.Parameters.Add("@office", SqlDbType.VarChar).Value = office;
                SqlCmd.Parameters.Add("@venue", SqlDbType.VarChar).Value = GroupVenueDropDownList;
                SqlCmd.Parameters.Add("@venuecountry", SqlDbType.VarChar).Value = venuecountry;
                da = new SqlDataAdapter(SqlCmd);
            ...
            else if (GroupVenueDropDownList == "Flybuy" || GroupVenueDropDownList == "FLYBUY")
            {
                ...
                SqlCommand SqlCmd = new SqlCommand("select distinct TO_Manager_name from TO_manager where office=@office  and TO_Manager_Status ='Active' and VenueCountry_ID=@venuecountry order by 1", cs1);
                SqlCmd.Parameters.Add("@office", SqlDbType.VarChar).Value = office;
                //SqlCmd.Parameters.Add("@venue", SqlDbType.VarChar).Value = venue;
                SqlCmd.Parameters.Add("@venuecountry", SqlDbType.VarChar).Value = venuecountry;
                da = new SqlDataAdapter(SqlCmd);
    ...
    public static DataSet LoadButtonUp(string office, string venue, string venuecountry, string GroupVenueDropDownList)
    {
        ...
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            ...
            /*  if (GroupVenueDropDownList == "Inhouse" || GroupVenueDropDownList == "INHOUSE")
              {
                  SqlCommand SqlCmd = new SqlCommand("select distinct ButtonUp_Name from Buttonup where office=@office  and ButtonUp_status ='Active' and Group_Venue='" + GroupVenueDropDownList + "' and VenueCountry_ID=@venuecountry order by 1", cs1);
                  SqlCmd.Parameters.Add("@office", SqlDbType.VarChar).Value = office;
                  SqlCmd.Parameters.Add("@venue", SqlDbType.VarChar).Value = venue;
                  SqlCmd.Parameters.Add("@venuecountry", SqlDbType.VarChar).Value = venuecountry;
                  da = new SqlDataAdapter(SqlCmd);
              ...
              else if (GroupVenueDropDownList == "Flybuy" || GroupVenueDropDownList == "FLYBUY")
              {
                  ...
                  SqlCommand SqlCmd = new SqlCommand("select distinct ButtonUp_Name from Buttonup where office=@office  and ButtonUp_status ='Active' and VenueCountry_ID=@venuecountry order by 1", cs1);
                  SqlCmd.Parameters.Add("@office", SqlDbType.VarChar).Value = office;
                  //SqlCmd.Parameters.Add("@venue", SqlDbType.VarChar).Value = venue;
                  SqlCmd.Parameters.Add("@venuecountry", SqlDbType.VarChar).Value = venuecountry;
                  da = new SqlDataAdapter(SqlCmd);
    ...
    public static DataSet LoadPrintFiles3(string conttype, string office, string globContClub, string PaymentMethod2, string affil2, string CrownCurr, string FracMem)
    {
        SqlDataAdapter da;
        DataSet ds = new DataSet();
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            SqlCommand SqlCmd = new SqlCommand("select LTRIM(RTRIM(p.Printpdf_name)) as Printpdf_name from ContractType a,printpdf p where a.contracttype_id = p.contracttype_id  and a.ContractType_name = @ContractType_name and p.Printpdf_office=@Printpdf_office and p.Print_pdf_Club=@Print_pdf_Club and Printpdf_Status='Active' and Printpdf_Affil='' and Printpdf_Fina='' and Printpdf_Fina_Curr=@fina_curr and Printpdf_FracMem=@frac_mem union select LTRIM(RTRIM(p.Printpdf_name)) as Printpdf_name from ContractType a,printpdf p where a.contracttype_id = p.contracttype_id  and a.ContractType_name = @ContractType_name and p.Printpdf_office=@Printpdf_office and p.Print_pdf_Club=@Print_pdf_Club and Printpdf_Status='Active' and Printpdf_Affil='' and Printpdf_Fina=@fina and Printpdf_Fina_Curr=@fina_curr and Printpdf_FracMem=@frac_mem ", cs1);
            SqlCmd.Parameters.Add("@ContractType_name", SqlDbType.VarChar).Value = conttype;
            SqlCmd.Parameters.Add("@Printpdf_office", SqlDbType.VarChar).Value = office;
            SqlCmd.Parameters.Add("@Print_pdf_Club", SqlDbType.VarChar).Value = globContClub;
    ...
    public static DataSet LoadFractionalC()
    {
        SqlDataAdapter da;
        DataSet ds = new DataSet();
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            SqlCommand SqlCmd = new SqlCommand("select Contract_Fractional_Club_Name from Contract_Fractional_Club where Contract_Fractional_Club_Status = 'Active' order by 1", cs1);
            //SqlCmd.Parameters.Add("@ContractType_name", SqlDbType.VarChar).Value = conttype;
            //SqlCmd.Parameters.Add("@Printpdf_office", SqlDbType.VarChar).Value = office;
            da = new SqlDataAdapter(SqlCmd);
            ds = new DataSet();
    ...
    public static int InsertContractFinance(string Contract_Finnace_ID, string Contract_Finance_Cont_Numb, string Contract_Finance_Cont_Type, string Contract_Finance_Affil_ICE, string Contract_Finance_Affil_HP, string Contract_Finance_Sales_Rep, string Contract_Finance_TO_Manager, string Contract_Finance_Button_UP, string Contract_Finance_Currency, string Contract_Finance_Purchase_Price, string Contract_Finance_Admin_Fees, string Contract_Finance_MC_Fees, string Contract_Finance_Deal_Drawer, string Contract_Finance_Payment_Method, string Contract_Finance_Finance_Num, string Contract_Finance_BPayment_Method, string Contract_Finance_Pan_Card, string Contract_Finance_Adhar_Card, string Contract_Finance_ID_Card, string Profile_ID, string office, string CrownCurr, string DealRegDate, string Contract_finance_OddEven, string Contract_finance_OddEven50, DateTime Contract_finance_Insert_Date, DateTime Contract_finance_Update_Date, int weekno, string Contract_finance_comments, string Contract_Finance_Payment_Method_Details, string Contract_Finance_Purchase_Price_old, string Contract_Finance_Admin_Fees_old, string Contract_Finance_UPDG, string Contract_Finance_UGDG_Venue, string Contract_Finance_UGDG_Old_Cont_Numb, string Boverride, string Contract_Finance_Purchase_Price_USD, string Contract_Finance_Admin_Fees_USD, string Contract_Finance_Cool_OnOff, string Contract_Finance_Cool_Start_Date, string Contract_Finance_Cool_End_Date, string Contract_Finance_Contract_Venue, string CO_Deal_Reg_Date, int CO_WeekNo, string CancelSameVenue)
    {
        ...
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            try
            {
                ...
                da.InsertCommand.Parameters.Add("@Contract_Finance_Override", SqlDbType.VarChar).Value = Boverride;
                da.InsertCommand.Parameters.Add("@Contract_Finance_Purchase_Price_USD", SqlDbType.VarChar).Value = Contract_Finance_Purchase_Price_USD;
                da.InsertCommand.Parameters.Add("@Contract_Finance_Admin_Fees_USD", SqlDbType.VarChar).Value = Contract_Finance_Admin_Fees_USD;

                da.InsertCommand.Parameters.Add("@Contract_Finance_Cool_OnOff", SqlDbType.VarChar).Value = Contract_Finance_Cool_OnOff;
                da.InsertCommand.Parameters.Add("@Contract_Finance_Contract_Venue", SqlDbType.VarChar).Value = Contract_Finance_Contract_Venue;
                da.InsertCommand.Parameters.Add("@DealRegDateCO", SqlDbType.VarChar).Value = CO_Deal_Reg_Date;
                da.InsertCommand.Parameters.Add("@weeknoCO", SqlDbType.Int).Value = CO_WeekNo;
                da.InsertCommand.Parameters.Add("@CancelSameVenue", SqlDbType.VarChar).Value = CancelSameVenue;
                da.InsertCommand.Parameters.Add("@contprocessdate", SqlDbType.VarChar).Value = "";
                //  da.InsertCommand.Parameters.Add("@Contract_Finance_Cool_Start_Date", SqlDbType.VarChar).Value = Contract_Finance_Cool_Start_Date;CancelSameVenue
                //   da.InsertCommand.Parameters.Add("@Contract_Finance_Cool_End_Date", SqlDbType.VarChar).Value = Contract_Finance_Cool_End_Date;
    ...
    public static int InserPurchaseService(string PS_ID, string PS_Deposit_Pay_Method, string PS_Deposit, string PS_Deposit_PA, string PS_Deposit_SA, string PS_PA_Admission, string PS_SA_Application, string PS_PA_Administration, string PS_SA_Administration, string PS_Total_Purchase, string PS_Total_Service, string PS_Country_Tax, string PS_Grand_Total, string PS_PA_Balance_Due, string PS_SA_Balance_Due, string PS_PA_No_Install, string PS_SA_No_Install, string PS_PA_FInstall_Date, string PS_SA_FInstall_Date, string PS_PA_Install_Amt, string PS_SA_Install_Amt, string PS_PA_FInstall_Amt, string PS_SA_FInstall_Amt, string PS_PA_Balance_Due_Dates, string PS_SA_Balance_Due_Dates, string PS_Remarks, string PS_EURO_Rate, string PS_AUS_Rate, string PS_GBP_Rate, string PS_IDA_Rate, string PS_Pay_Protect, string PS_YOInterest, string Profile_ID, string Contract_Finance_ID, string Total_Balance, DateTime PS_Date_Of_Insert, string office, string PS_PA_Balance_Due_Dates2, string PS_SA_Balance_Due_Dates2, string PS_Remarks2, string PS_Initial_Deposit, string PS_Bal_Deposit, string PS_Deposit_Date, string PS_CPA_Commnet, string PS_Ini_Bal_Install, string PS_Ini_Bal_Install_Amt, string PS_Balloon_Pay, string PS_PA_Last_Install_Date, string PS_Deposit_Comment, string PS_BalanceDue_TD, string PS_Deposit_Old, string PS_Country_Tax_Old, string PS_Deposit_USD, string PS_Country_Tax_USD, string PS_Country_Tax_CGST, string PS_Country_Tax_SGST, string PS_ERate_INR, string PS_TP_Comment, string PS_Deposit_Date_Main)
    {
        ...
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            try
            {
                ...
                da.InsertCommand.Parameters.Add("@PS_Deposit_USD", SqlDbType.VarChar).Value = PS_Deposit_USD;
                da.InsertCommand.Parameters.Add("@PS_Country_Tax_USD", SqlDbType.VarChar).Value = PS_Country_Tax_USD;
                da.InsertCommand.Parameters.Add("@PS_Country_Tax_CGST", SqlDbType.VarChar).Value = PS_Country_Tax_CGST;
                da.InsertCommand.Parameters.Add("@PS_Country_Tax_SGST", SqlDbType.VarChar).Value = PS_Country_Tax_SGST;
                da.InsertCommand.Parameters.Add("@PS_ERate_INR", SqlDbType.VarChar).Value = PS_ERate_INR;
                da.InsertCommand.Parameters.Add("@PS_TP_Comment", SqlDbType.VarChar).Value = PS_TP_Comment;
                da.InsertCommand.Parameters.Add("@PS_Deposit_Date_Main", SqlDbType.VarChar).Value = PS_Deposit_Date_Main;
    ...
    public static int InserPaymentDetails(string Payment_Details_ID, string Payment_Details_PCard_Type, string Payment_Details_PIssuing_Bank, string Payment_Details_PCredit_Card_No, string Payment_Details_PCard_Holders_Name, string Payment_Details_PExpiry, string Payment_Details_PSecurity_No, string Payment_Details_PFor_Depo, string Payment_Details_PFor_Bala, string Payment_Details_SCard_Type, string Payment_Details_SIssuing_Bank, string Payment_Details_SCredit_Card_No, string Payment_Details_SCard_Holders_Name, string Payment_Details_SExpiry, string Payment_Details_SSecurity_No, string Payment_Details_SFor_Depo, string Payment_Details_SFor_Bala, string Profile_ID, string Contract_Finance_ID, DateTime Payment_Details_Insert_Date, string office, string pcomments, string scomments, string Payment_Details_Enc_PCredit_Card_No,string Payment_Details_Enc_PCredit_Card_No_Front)
    {
        ...
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            try
            {
                ...
                da.InsertCommand.Parameters.Add("@Payment_Details_Enc_PCredit_Card_No", SqlDbType.VarChar).Value = Payment_Details_Enc_PCredit_Card_No;
                da.InsertCommand.Parameters.Add("@Payment_Details_Enc_PCredit_Card_No_Front", SqlDbType.VarChar).Value = Payment_Details_Enc_PCredit_Card_No_Front;
    ...
    public static DataSet CrownFinaCurr()
    {
        ...
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            SqlCommand SqlCmd = new SqlCommand("select Finance_Curr_Name from Crown_Finance_Curr where Finance_Curr_Status='Active' and Finance_Curr_Name <> 'USD' order by Finance_Curr_Name  ", cs1);
    ...
    public static string PnumbCount(string midval, string office)
    {
        ...
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            ...
            SqlCommand scmd = new SqlCommand("select PnumberCount_start_val from PnumberCount where PnumberCount_curr=@midval and PnumberCount_Office=@office", cs1);
            scmd.Parameters.Add("@midval", SqlDbType.VarChar).Value = midval;
            scmd.Parameters.Add("@office", SqlDbType.VarChar).Value = office;
            startval = (string)scmd.ExecuteScalar();

            SqlCommand scmd2 = new SqlCommand("select PnumberCount_EndVal from PnumberCount where PnumberCount_curr=@midval and PnumberCount_Office=@office", cs1);
            scmd2.Parameters.Add("@midval", SqlDbType.VarChar).Value = midval;
            scmd2.Parameters.Add("@office", SqlDbType.VarChar).Value = office;
            EndVal = (string)scmd2.ExecuteScalar();



            SqlCommand scmd1 = new SqlCommand("select PnumberCount_End_val from PnumberCount where PnumberCount_curr=@midval and PnumberCount_Office=@office", cs1);
            scmd1.Parameters.Add("@midval", SqlDbType.VarChar).Value = midval;
            scmd1.Parameters.Add("@office", SqlDbType.VarChar).Value = office;
            int val = (int)scmd1.ExecuteScalar();

            id = Convert.ToInt32(val) + 1;

            Pnumbnumb = startval + EndVal + id;
    ...
    public static string getExchangeRate(string midval)
    {
        ...
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            ...
            {
                SqlCommand scmd = new SqlCommand("select ERates_IDR from Exchange_Rate where ERates_Status ='Active' and office='IVO'", cs1);
                //scmd.Parameters.Add("@midval", SqlDbType.VarChar).Value = midval;
                //val = (float)scmd.ExecuteScalar();
                val = (double)scmd.ExecuteScalar();
                // = scmd.ExecuteScalar().tostring();
            ...
            {
                SqlCommand scmd = new SqlCommand("select ERates_INR from Exchange_Rate where ERates_Status ='Active' and office='IVO'", cs1);
                //scmd.Parameters.Add("@midval", SqlDbType.VarChar).Value = midval;
                //val = (float)scmd.ExecuteScalar();
                val = (double)scmd.ExecuteScalar();
                // = scmd.ExecuteScalar().tostring();
    ...
    public static int UpdatePnumber(string CrownCurr, string office)
    {
        int rows = 0;
        int id = 0;
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            try
            {
                ...
                SqlCommand sqlcmd = new SqlCommand("update PnumberCount set PnumberCount_End_val = '" + id + "' where PnumberCount_curr=@midval and PnumberCount_Office=@office", cs1);
    ...
    //insert logs
    public static int InsertContractLogs(string ProfileID, String ContractNo, String UpdatedField, string area, string Username, DateTime Log_Entry)
    {
        int rowsAffected = 0;
        SqlDataAdapter da = new SqlDataAdapter();
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            try
            {
                ...
                da.InsertCommand.Parameters.Add("@Log_Entry", SqlDbType.DateTime).Value = Log_Entry;
                rowsAffected = da.InsertCommand.ExecuteNonQuery();
            }
            catch (Exception ex)
            {
    ...
    public static string LoadPointCont(string office, string club_name, string venuecountry, string venue, string mark, string markp, string curr, string coolonoff)
    {
        //SqlDataAdapter da;
        //DataSet dt = new DataSet();
        string sendval, date = "", startv, endv, incr1, suff;
        //curr = HttpContext.Current.Session["Globcurr"].ToString();
        int incr2, incr3;
        string final = null;
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            // changed venue to mark and mark to venue
            if (mark == "Inhouse" || mark == "INHOUSE")
            {
                if (venue == "KR BOAT LAGOON - PHUKET" || venue == "Kr Boat Lagoon - Phuket")
                {
                    if (club_name == "Royalty Gold Club" && curr == "INR")
                    {
                        SqlCommand SqlCmd = new SqlCommand("select Contract_Code+'63/IN' from Contract_Club where Contract_Club_Name=@club_name and Office=@office and Venue_Country_ID in (select Venue_Country_ID from VenueCountry where Venue_Country_Name=@venuecountry)", cs1);
                        SqlCmd.Parameters.Add("@office", SqlDbType.VarChar).Value = office;
                    ...
                    {
                        SqlCommand SqlCmd = new SqlCommand("select Contract_Code+'63' from Contract_Club where Contract_Club_Name=@club_name and Office=@office and Venue_Country_ID in (select Venue_Country_ID from VenueCountry where Venue_Country_Name=@venuecountry)", cs1);
                        SqlCmd.Parameters.Add("@office", SqlDbType.VarChar).Value = office;
                        SqlCmd.Parameters.Add("@club_name", SqlDbType.VarChar).Value = club_name;
                        SqlCmd.Parameters.Add("@venuecountry", SqlDbType.VarChar).Value = venuecountry;
                        // SqlCmd.Parameters.Add("@venue", SqlDbType.VarChar).Value = venue;
                ...
                else if (venue == "KARMA APSARA" || venue == "Karma Apsara")
                {
                    if (club_name == "Royalty Gold Club" && curr == "INR")
                    {
                        SqlCommand SqlCmd = new SqlCommand("select Contract_Code+'64/IN' from Contract_Club where Contract_Club_Name=@club_name and Office=@office and Venue_Country_ID in (select Venue_Country_ID from VenueCountry where Venue_Country_Name=@venuecountry)", cs1);
                        SqlCmd.Parameters.Add("@office", SqlDbType.VarChar).Value = office;
                        SqlCmd.Parameters.Add("@club_name", SqlDbType.VarChar).Value = club_name;
                        SqlCmd.Parameters.Add("@venuecountry", SqlDbType.VarChar).Value = venuecountry;
                        // SqlCmd.Parameters.Add("@venue", SqlDbType.VarChar).Value = venue;
                    ...
                    {
                        SqlCommand SqlCmd = new SqlCommand("select Contract_Code+'64' from Contract_Club where Contract_Club_Name=@club_name and Office=@office and Venue_Country_ID in (select Venue_Country_ID from VenueCountry where Venue_Country_Name=@venuecountry)", cs1);
                        SqlCmd.Parameters.Add("@office", SqlDbType.VarChar).Value = office;
                        SqlCmd.Parameters.Add("@club_name", SqlDbType.VarChar).Value = club_name;
                        SqlCmd.Parameters.Add("@venuecountry", SqlDbType.VarChar).Value = venuecountry;
                        // SqlCmd.Parameters.Add("@venue", SqlDbType.VarChar).Value = venue;
                ...
                else
                {
                    if (club_name == "Royalty Gold Club" && curr == "INR")
                    {
                        SqlCommand SqlCmd = new SqlCommand("select Contract_Code+''+contract_suffix+'/IN' from Contract_Club where Contract_Club_Name=@club_name and Office=@office and Venue_Country_ID in (select Venue_Country_ID from VenueCountry where Venue_Country_Name=@venuecountry)", cs1);
                        SqlCmd.Parameters.Add("@office", SqlDbType.VarChar).Value = office;
                        SqlCmd.Parameters.Add("@club_name", SqlDbType.VarChar).Value = club_name;
                        SqlCmd.Parameters.Add("@venuecountry", SqlDbType.VarChar).Value = venuecountry;
                        // SqlCmd.Parameters.Add("@venue", SqlDbType.VarChar).Value = venue;
                    ...
                    {
                        SqlCommand SqlCmd = new SqlCommand("select Contract_Code+''+contract_suffix from Contract_Club where Contract_Club_Name=@club_name and Office=@office and Venue_Country_ID in (select Venue_Country_ID from VenueCountry where Venue_Country_Name=@venuecountry)", cs1);
                        SqlCmd.Parameters.Add("@office", SqlDbType.VarChar).Value = office;
                        SqlCmd.Parameters.Add("@club_name", SqlDbType.VarChar).Value = club_name;
                        SqlCmd.Parameters.Add("@venuecountry", SqlDbType.VarChar).Value = venuecountry;
                        // SqlCmd.Parameters.Add("@venue", SqlDbType.VarChar).Value = venue;
                ...
                SqlCommand SqlCmd4 = new SqlCommand("select isnull(ContF_Gen_Lcode,'') from venue2 v2 join venue v on v.Venue_ID=v2.Venue_ID  where v2.Venue2_Name = @mark and v.venue_name='" + venue + "'", cs1);
                //// SqlCmd4.Parameters.Add("@venuecountry", SqlDbType.VarChar).Value = venuecountry;
                // SqlCmd4.Parameters.Add("@venue", SqlDbType.VarChar).Value = venue;
                SqlCmd4.Parameters.Add("@mark", SqlDbType.VarChar).Value = mark;
                endv = (string)SqlCmd4.ExecuteScalar();
                ...
                SqlCommand SqlCmd5 = new SqlCommand("select ContP_Inc_val from venue2 v2 join venue v on v.Venue_ID=v2.Venue_ID  where v2.Venue2_Name = @mark and v.venue_name='" + venue + "'", cs1);
                //// SqlCmd4.Parameters.Add("@venuecountry", SqlDbType.VarChar).Value = venuecountry;
                // SqlCmd4.Parameters.Add("@venue", SqlDbType.VarChar).Value = venue;
            ...
            {
                if (office == "THL")//if (mark == "KR BOAT LAGOON - PHUKET" || mark == "Kr Boat Lagoon - Phuket")
                {
                    if (club_name == "Royalty Gold Club" && curr == "INR")
                    {
                        SqlCommand SqlCmd = new SqlCommand("select Contract_Code+'64/IN' from Contract_Club where Contract_Club_Name=@club_name and Office=@office and Venue_Country_ID in (select Venue_Country_ID from VenueCountry where Venue_Country_Name=@venuecountry)", cs1);
                ...
                /*else if (mark == "Koh Samui" || mark == "KOH SAMUI")
                {
                    if (club_name == "Royalty Gold Club" && curr == "INR")
                    {
                        SqlCommand SqlCmd = new SqlCommand("select Contract_Code+'64/IN' from Contract_Club where Contract_Club_Name=@club_name and Office=@office and Venue_Country_ID in (select Venue_Country_ID from VenueCountry where Venue_Country_Name=@venuecountry)", cs1);
            ...
            if (mark == "Inhouse" || mark == "INHOUSE")
            {
                SqlCommand SqlCmd6 = new SqlCommand("select isnull(Cont_Suffix_Code,'') from venue2 v2 join venue v on v.Venue_ID=v2.Venue_ID  where v2.Venue2_Name = @mark and v.venue_name='" + venue + "'", cs1);
                //// SqlCmd4.Parameters.Add("@venuecountry", SqlDbType.VarChar).Value = venuecountry;
                // SqlCmd4.Parameters.Add("@venue", SqlDbType.VarChar).Value = venue;
                ...
                else
                {
                    if (coolonoff == "0")
                    {
                        ...
                        {
                            final = sendval + "/S/" + date + "/" + incr3 + endv + suff;
                        }
            ...
            else if (mark == "Flybuy" || mark == "FLYBUY")
            {
                if (markp == "FBW" || markp == "FBI" || markp == "FLYBUY")
                {
                    if (markp == "FBW")
                    {
                        string FB = "FBW";
                ...
                else if (markp == "KE2W" || markp == "KE INDO")
                {
                    string FB = "KE";
                    final = sendval + '/' + date + '/' + incr3 + endv + FB;
                }
            ...
            else if (mark == "Coldline" || mark == "COLDLINE")
            {
                if (markp == "KCV1")
                {
                    string FB = "KC";
            ...
            /* else
             {
                 ...
                 if (venue == "Flybuy")
                 {
                     if (markp == "FLYBUY AUS" || markp == "FLYBUY INDO"  || markp == "FLYBUY" )
                     {
                         if (markp == "FLYBUY AUS")
                         {
                             string FB = "FBA";
    ...
    public static string LoadFracCont(string office, string club_name, string venuecountry, string venue, string mark, string markp, string resort, string coolonoff, string curr)
    {
        //SqlDataAdapter da;
        //DataSet dt = new DataSet();
        ...
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            ...
            SqlCommand SqlCmd3 = new SqlCommand("select isnull(ContF_Gen_Scode,'') from venue2 v2 join venue v on v.Venue_ID=v2.Venue_ID  where v2.Venue2_Name = @mark and v.venue_name='" + venue + "'", cs1);
            SqlCmd3.Parameters.Add("@mark", SqlDbType.VarChar).Value = mark;
            ...
            if (mark == "Inhouse" || mark == "INHOUSE")
            {
                ...
                if (resort == "FM")
                {
                    SqlCommand SqlCmd5 = new SqlCommand("select convert(int,ContFM_Inc_Val) ContFM_Inc_Val from venue2 v2 join venue v on v.Venue_ID=v2.Venue_ID  where v2.Venue2_Name = @mark and v.venue_name='" + venue + "'", cs1);
                ...
                {
                    SqlCommand SqlCmd5 = new SqlCommand("select ContF_Inc_Val from venue2 v2 join venue v on v.Venue_ID=v2.Venue_ID  where v2.Venue2_Name = @mark and v.venue_name='" + venue + "'", cs1);
            ...
            if (office == "IVO")
            {
                ...
                else if (mark == "Coldline" || mark == "COLDLINE" || mark == "Flybuy" || mark == "FLYBUY")
                {
                    if (resort == "FM")
                    {
                        sendval = "KRRM9";
            ...
            else if (office == "THL")
            {
                ...
                else if (venue == "Koh Samui" || venue == "KOH SAMUI")
                {
        ...
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            try
            {
                ...
                if (mark == "Inhouse" || mark == "INHOUSE")
                {
                    ...
                    SqlCommand SqlCmd6 = new SqlCommand("update venue2 set ContP_Inc_val= '" + incr3 + "' from venue2 v2 join venue v on v.Venue_ID=v2.Venue_ID  where v2.Venue2_Name = @mark and v.venue_name='" + venue + "'", cs1);
        ...
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            try
            {
                ...
                if (mark == "Inhouse" || mark == "INHOUSE")
                {
                    ...
                    SqlCommand SqlCmd6 = new SqlCommand("update venue2 set ContF_Inc_Val = '" + incr3 + "' from venue2 v2 join venue v on v.Venue_ID=v2.Venue_ID  where v2.Venue2_Name = @mark and v.venue_name='" + venue + "'", cs1);
...
public static int UpdateFracCont(string office, string venuecountry, string venue, string mark, string resort)
    {
        int rowsAffected = 0;
        string incr4;
        int incr1, id, incr3, incr2;
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            try
            {
                ...
                if (mark == "Inhouse" || mark == "INHOUSE")
                {
                    if (resort == "FM")
                    {
                        SqlCommand SqlCmd5 = new SqlCommand("select convert(int,ContFM_Inc_Val) from  venue2 v2 join venue v on v.Venue_ID=v2.Venue_ID  where v2.Venue2_Name = @mark and v.venue_name='" + venue + "'", cs1);
                        ...
                        SqlCommand SqlCmd6 = new SqlCommand("update venue2 set ContFM_Inc_Val = '" + incr3 + "' from venue2 v2 join venue v on v.Venue_ID=v2.Venue_ID  where v2.Venue2_Name = @mark and v.venue_name='" + venue + "'", cs1);
    ...
    public static string LoadPropfess(string cur, string FOccu, string club)
    {
        ...
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            SqlCommand SqlCmd = new SqlCommand("select isnull(charge_Property_fee_per_year,'0') as charge_Property_fee_per_year from Property_fee_charge where charge_year = ltrim(rtrim('" + FOccu + "')) and Currency='" + cur + "' and charge_status='Active' and club='" + club + "'", cs1);
            // SqlCmd.Parameters.Add("@Nopoints", SqlDbType.VarChar).Value = NoPoints;

            sendval1 = (double)SqlCmd.ExecuteScalar();

            SqlCommand SqlCmd2 = new SqlCommand("select isnull(charge_member_fee,'0') as charge_member_fee from Property_fee_charge where charge_year = ltrim(rtrim('" + FOccu + "')) and Currency='" + cur + "' and charge_status='Active'and club='" + club + "'", cs1);
    ...
    public static int UpdateContract_Fractional(string ResortF, string ResidenceNoF, string ResidenceTypeF, string FractionalInt, string FractEntitle, string FractFOccu, string FractDura, string FractLOccustring, string Fracid, string FractLease)
    {
        int rowsAffected = 0;
        //int incr1, id, incr3;
        using (SqlConnection cs1 = Queries.GetDBConnection())
    ...
    public static int Update_Contract_TF(string OldAgreeNoTF, string OldClubTF, string OldNoOfPointsTF, string OldEntitleTF, string OldResortTF, string OldAppartTypeTF, string OldNoOccuTF, string OldPeriodTF, string OldSeasonTF, string OldResidenceNoTF, string OldResiTypeTF, string OldFracIntTF, string ResortTF, string ResidenceNoTF, string ResidenceTypeTF, string TFractionalInt, string TFractEntitle, string TFractFOccu, string TFractDura, string TFractLOccu, string Fracid, string TFractLease)
    {
        ...
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            try
            {
                ...
                SqlCommand SqlCmd6 = new SqlCommand("update Contract_TF set TF_Old_Cont_Numb='" + OldAgreeNoTF + "',	TF_Old_Club='" + OldClubTF + "',	TF_Old_NoOf_Points='" + OldNoOfPointsTF + "',	TF_Old_Entitle='" + OldEntitleTF + "',	TF_Old_Resort='" + OldResortTF + "',	TF_Old_Apmnt_Type='" + OldAppartTypeTF + "',	TF_Old_No_Occu='" + OldNoOccuTF + "',	TF_Old_Period='" + OldPeriodTF + "',	TF_Old_Season='" + OldSeasonTF + "',	TF_Old_Resi_No='" + OldResidenceNoTF + "',	TF_Old_Resi_Type='" + OldResiTypeTF + "',	TF_Old_Frac_Int='" + OldFracIntTF + "',	TF_Resort='" + ResortTF + "',	TF_Resi_No='" + ResidenceNoTF + "',	TF_Resi_Type='" + ResidenceTypeTF + "',	TF_Frac_Int='" + TFractionalInt + "',	TF_Entitle='" + TFractEntitle + "',	TF_First_Occ='" + TFractFOccu + "',	TF_Duration='" + TFractDura + "',	TF_Last_Occ='" + TFractLOccu + "',	TF_Leas='" + TFractLease + "' where Contract_Finance_ID=@Fracid", cs1);
    ...
    public static int checkforexistingfinancedetails(string midval, string check)
    {
        ...
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            ...
            {
                SqlCommand scd = new SqlCommand("select count(*) from Parshuram_Finance_Details where Contract_Finance_ID =@midval", cs1);
                scd.Parameters.Add("@midval", SqlDbType.VarChar).Value = midval;
    ...
    public static int InsertStatusChange(string SC_ID, string SC_Previous_Status, string SC_Updated_Status, string SC_Cancel_Group_Venue, string SC_Cancel_Reason, string SC_Cancel_Date, string SC_User, string Profile_ID, string Contract_Finance_ID, string SC_Update_Date, string Contract_num_new, string SC_Cancel_Type, string SC_Cancel_Comment, string SC_Withdraw_Date)
    {
        int rowsAffected = 0;
        int year = DateTime.Now.Year;
        int id = 0;
        ...
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            try
            {
                da.InsertCommand = new SqlCommand("insert into status_change values(@SC_ID,@SC_Previous_Status,@SC_Updated_Status,@SC_Cancel_Group_Venue,@SC_Cancel_Reason,@SC_Cancel_Date,@SC_User,@Profile_ID,@Contract_Finance_ID,@SC_Update_Date,@Contract_num_new,@SC_Cancel_Type,@SC_Cancel_Comment,@SC_Withdraw_Date)", cs1);
                ...
                da.InsertCommand.Parameters.Add("@SC_Cancel_Type", SqlDbType.VarChar).Value = SC_Cancel_Type;
                da.InsertCommand.Parameters.Add("@SC_Cancel_Comment", SqlDbType.VarChar).Value = SC_Cancel_Comment;
                da.InsertCommand.Parameters.Add("@SC_Withdraw_Date", SqlDbType.VarChar).Value = SC_Withdraw_Date;
                rowsAffected = da.InsertCommand.ExecuteNonQuery();
    ...
    public static int Update_Status_change(string SC_Cancel_Group_Venue, string SC_Cancel_Reason, string SC_Cancel_Date, string curdate, string dealstat, string Fracid, string SC_Cancel_Type, string SC_Cancel_Comment, string SC_Withdraw_Date)
    {
        int rowsAffected = 0;
        //int incr1, id, incr3;
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            try
            {
                ...
                SqlCommand SqlCmd6 = new SqlCommand("update status_change set SC_Cancel_Group_Venue='" + SC_Cancel_Group_Venue + "',SC_Cancel_Reason='" + SC_Cancel_Reason + "',SC_Update_Date='" + curdate + "',SC_Cancel_Date='" + SC_Cancel_Date + "',SC_Cancel_Type='" + SC_Cancel_Type + "',SC_Cancel_Comment='" + SC_Cancel_Comment + "',SC_Withdraw_Date='" + SC_Withdraw_Date + "' where SC_ID in(select SC_ID from status_change where  SC_Update_Date in (select max(SC_Update_Date)as date from status_change where Contract_Finance_ID=@Fracid and SC_Updated_Status=@dealstat))", cs1);
...
// SqlCommand scd = new SqlCommand("select Profile_ID from Contract_Finance where  Contract_Finance_Cont_Numb=@midval", cs1);
            //select Profile_ID from Contract_Finance where  Contract_Finance_Cont_Numb='' union select ProfileID from ContractDetails_Indian where ContractNo=''
            SqlCommand scd = new SqlCommand("select Profile_ID from Contract_Finance where  Contract_Finance_Cont_Numb=@midval union select ProfileID from ContractDetails_Indian where ContractNo=@midval", cs1);																																					 
            scd.Parameters.Add("@midval", SqlDbType.VarChar).Value = midval;
    ...
    public static int InsertIntoContractAudit(string Profile_ID, string Contract_No, string Fname, string Lname, string ContCreateDate, string ProcessDate)
    {
        ...
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            try
            {
                da.InsertCommand = new SqlCommand("insert into Contract_Audit1 values(@Profile_ID,@Contract_No,@Fname,@Lname,@ContCreateDate,@ProcessDate,@APIStatus,@APIFailureReason)", cs1);
                da.InsertCommand.Parameters.Add("@Profile_ID", SqlDbType.VarChar).Value = Profile_ID;
                ...
                da.InsertCommand.Parameters.Add("@APIStatus", SqlDbType.VarChar).Value = "";
                da.InsertCommand.Parameters.Add("@APIFailureReason", SqlDbType.VarChar).Value = "";
    ...
    public static DataSet LoadSubVenue2(string venue1)
    {
        ...
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            ...
            SqlCommand SqlCmd = new SqlCommand("select @venue as SVenue_Name union select 'Member Relation' union select 'Odyssey' as SVenue_Name", cs1);
            SqlCmd.Parameters.Add("@venue", SqlDbType.VarChar).Value = venue1;
            da = new SqlDataAdapter(SqlCmd);
            ds = new DataSet();
            da.Fill(ds);
      ...
      public static string getcountrycodefromstring(string data)
    {
        ...
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            SqlCommand sqcmd = new SqlCommand("select Country_Code  from country where country_code+'  '+Country_Name='" + data + "' or country_code+' '+Country_Name='" + data + "'", cs1);
    ...
    public static DataTable loadDSR1(string year, string COUNTRY, string VENUE, string group)
    {
        ...
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            ...
            cmd_sp.Parameters.AddWithValue("@VENUE", VENUE);
            cmd_sp.Parameters.AddWithValue("@COUNTRY", COUNTRY);
            cmd_sp.Parameters.AddWithValue("@group", group);
    ...
    public static DataTable loadDSR1_2(string year, string COUNTRY, string VENUE, string group)
    {
    ...
    public static DataTable loadDSR2(string year, string COUNTRY, string VENUE, string group)
    {
    ...
    public static DataTable loadDSR3(string year, string COUNTRY, string VENUE, string group)
    {
    ...
    public static DataTable loadDSR4(string year, string COUNTRY, string VENUE, string group)
    {
    ...
    public static DataTable inhouse(string input, string country, string venue, string gvenue, string group)
    {

        using (SqlConnection cs1 = Queries2.GetDBConnection())
        {

            SqlCommand cmd_sp = new SqlCommand("Inhouse2", cs1);
            // cmd.CommandText = "holiday_confirm";
            cmd_sp.CommandType = CommandType.StoredProcedure;
    ...
    public static DataTable Monthbudget(string input, string country, string group)
    {
    ...
    public static DataTable Yearbudget(string input, string country, string group)
    {
  ...
  public static DataTable Seapconsolcountry2(string DATE, string COUNTRY)
    {

        using (SqlConnection cs1 = Queries.GetDBConnection())
        {

            SqlCommand cmd_sp = new SqlCommand("consolcountryHMLaccount", cs1);
    ...
    public static DataSet LoadPrintFiles2(string conttype, string office, string globContClub, string PaymentMethod2, string affil2, string CrownCurr, string FracMem, string cooloff, string maincurr)
    {
        SqlDataAdapter da;
        DataSet ds = new DataSet();
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            SqlCommand SqlCmd = new SqlCommand("select LTRIM(RTRIM(p.Printpdf_name)) as Printpdf_name from ContractType a,printpdf p where a.contracttype_id = p.contracttype_id and a.ContractType_name = @ContractType_name and p.Printpdf_office=@Printpdf_office and p.Print_pdf_Club=@Print_pdf_Club and Printpdf_Status='Active' and Printpdf_Affil='' and Printpdf_Fina='' and Printpdf_Fina_Curr='' and Printpdf_FracMem=@frac_mem  and Printpdf_Cool=@cool and Printpdf_Lang='' union  select LTRIM(RTRIM(p.Printpdf_name)) as Printpdf_name from ContractType a,printpdf p where a.contracttype_id = p.contracttype_id and a.ContractType_name = @ContractType_name and p.Printpdf_office=@Printpdf_office and p.Print_pdf_Club=@Print_pdf_Club and Printpdf_Status='Active' and Printpdf_Affil=@affil and Printpdf_Fina='' and Printpdf_Fina_Curr='' and Printpdf_FracMem=@frac_mem  and Printpdf_Cool=@cool and Printpdf_Lang=''  union select LTRIM(RTRIM(p.Printpdf_name)) as Printpdf_name from ContractType a,printpdf p where a.contracttype_id = p.contracttype_id and a.ContractType_name = @ContractType_name and p.Printpdf_office=@Printpdf_office and p.Print_pdf_Club=@Print_pdf_Club and Printpdf_Status='Active'  and Printpdf_Affil=@affil and Printpdf_Fina=@fina and Printpdf_Fina_Curr='' and Printpdf_FracMem=@frac_mem  and Printpdf_Cool=@cool and Printpdf_Lang='' union select LTRIM(RTRIM(p.Printpdf_name)) as Printpdf_name from ContractType a,printpdf p where a.contracttype_id = p.contracttype_id and a.ContractType_name = @ContractType_name and p.Printpdf_office=@Printpdf_office and p.Print_pdf_Club=@Print_pdf_Club and Printpdf_Status='Active'  and Printpdf_Affil='' and Printpdf_Fina=@fina and Printpdf_Fina_Curr='' and Printpdf_FracMem=@frac_mem  and Printpdf_Cool=@cool  and Printpdf_Lang='' union select LTRIM(RTRIM(p.Printpdf_name)) as Printpdf_name from ContractType a,printpdf p where a.contracttype_id = p.contracttype_id and a.ContractType_name = @ContractType_name and p.Printpdf_office=@Printpdf_office and p.Print_pdf_Club=@Print_pdf_Club and Printpdf_Status='Active'  and Printpdf_Affil='' and Printpdf_Fina=@fina and Printpdf_Fina_Curr= @fina_curr and Printpdf_FracMem=@frac_mem  and Printpdf_Cool=@cool and Printpdf_Lang='' union select LTRIM(RTRIM(p.Printpdf_name)) as Printpdf_name from ContractType a,printpdf p where a.contracttype_id = p.contracttype_id and a.ContractType_name = @ContractType_name and p.Printpdf_office=@Printpdf_office and p.Print_pdf_Club=@Print_pdf_Club and Printpdf_Status='Active'  and Printpdf_Affil='' and Printpdf_Fina='' and Printpdf_Fina_Curr= @maincurr and Printpdf_FracMem=@frac_mem  and Printpdf_Cool=@cool  and Printpdf_Lang=''", cs1);
            SqlCmd.Parameters.Add("@ContractType_name", SqlDbType.VarChar).Value = conttype;
            SqlCmd.Parameters.Add("@Printpdf_office", SqlDbType.VarChar).Value = office;
            SqlCmd.Parameters.Add("@Print_pdf_Club", SqlDbType.VarChar).Value = globContClub;
            SqlCmd.Parameters.Add("@affil", SqlDbType.VarChar).Value = affil2;
            ...
            SqlCmd.Parameters.Add("@fina_curr", SqlDbType.VarChar).Value = CrownCurr;
            SqlCmd.Parameters.Add("@frac_mem", SqlDbType.VarChar).Value = FracMem;
            SqlCmd.Parameters.Add("@cool", SqlDbType.VarChar).Value = cooloff;
            SqlCmd.Parameters.Add("@maincurr", SqlDbType.VarChar).Value = maincurr;
    ...
    public static int InsertIntoVPNPost(string conttype, string office, string ptitle, string stitle, string sp1title, string sp2title, string sp3title, string sp4title, string profile_ID)
    {
        int rowsaffected = 0;
        string acctype = "", acctypeid = "", servicecenter = "", servicecenterid = "", Acountry = ""; int ppa, ps, sp1, sp2, sp3, sp4, sendval;
        using (SqlConnection cs2 = Queries2.GetDBConnection2())

        {
            try
            {
               ...
               /* if (office == "IVO" || office == "THL" || office == "VTM")
                {
                    servicecenter = "IVO";
                    servicecenterid = "38994";
                }
                else if (office == "HML")
                {
                    servicecenter = "HML";
                    servicecenterid = "38995";
                }*/

		 SqlCommand SqlCmdAdd = new SqlCommand("select distinct Profile_Address_Country from Profile_Address where Profile_ID = '" + profile_ID + "'", cs2);
                Acountry = (string)SqlCmdAdd.ExecuteScalar();


                if (Acountry == "INDONESIA" || Acountry == "THAILAND" || Acountry == "VIETNAM" || Acountry == "AUSTRALIA")
                {
                ...
                //SqlCommand SqlCmd = new SqlCommand("select VP_Salu_ID from Salutations where office='" + office + "' and Salutation='" + title + "' and Status='Active'", cs2);
                //SqlCmd.Parameters.Add("@office", SqlDbType.VarChar).Value = office;
                //SqlCmd.Parameters.Add("@club_name", SqlDbType.VarChar).Value = club_name;
                // SqlCmd.Parameters.Add("@venuecountry", SqlDbType.VarChar).Value = venuecountry;
                // SqlCmd.Parameters.Add("@venue", SqlDbType.VarChar).Value = venue;
                ...
                using (SqlConnection cs3 = Queries.GetDBConnection())
                {
                    SqlCommand SqlCmd2 = new SqlCommand("select count(*) from Profile_Primary where Profile_ID = '" + profile_ID + "'", cs3);
                    ppa = (int)SqlCmd2.ExecuteScalar();
                    SqlCommand SqlCmd3 = new SqlCommand("select count(*) from Profile_Secondary where Profile_ID = '" + profile_ID + "'", cs3);
                    ps = (int)SqlCmd3.ExecuteScalar();
                    SqlCommand SqlCmd4 = new SqlCommand("select count(*) from Sub_Profile1 where Profile_ID = '" + profile_ID + "'", cs3);
                    sp1 = (int)SqlCmd4.ExecuteScalar();
                    SqlCommand SqlCmd5 = new SqlCommand("select count(*) from Sub_Profile2 where Profile_ID = '" + profile_ID + "'", cs3);
                    sp2 = (int)SqlCmd5.ExecuteScalar();
                    SqlCommand SqlCmd6 = new SqlCommand("select count(*) from Sub_Profile3 where Profile_ID = '" + profile_ID + "'", cs3);
                    sp3 = (int)SqlCmd6.ExecuteScalar();
                    SqlCommand SqlCmd7 = new SqlCommand("select count(*) from Sub_Profile4 where Profile_ID = '" + profile_ID + "'", cs3);
                    sp4 = (int)SqlCmd7.ExecuteScalar();
                }
                ...
                if (ppa == 1)
                {
                    using (SqlConnection cs3 = Queries.GetDBConnection())
                    {
                        SqlCommand SqlCmd = new SqlCommand("select VP_Salu_ID from Salutations where office='" + office + "' and Salutation='" + ptitle + "' and Status='Active'", cs3);
                        sendval = (int)SqlCmd.ExecuteScalar();
                    }

                    SqlCommand scd = new SqlCommand("insert into VP_POST_Account select '','" + acctype + "','" + acctypeid + "','" + servicecenter + "','" + servicecenterid + "','94764','1',pp.Profile_Primary_Title,'" + sendval + "',pp.Profile_Primary_Fname,pp.Profile_Primary_Lname,e.Primary_Email,p.Primary_CC + +p.Primary_Mobile phone, p.Primary_Alt_CC + ' ' + p.Primary_Alternate mobile,pa.Profile_Address_Line1,pa.Profile_Address_Line2,'',pa.Profile_Address_State,pa.Profile_Address_Country,pa.Profile_Address_Postcode,pp.Profile_Primary_Nationality,pp.Profile_Primary_DOB,'1','1','0','0',pp.Profile_ID,'Primary','','0','' from [10.0.0.48].[contractapp2].[dbo].Profile_Primary pp left join [10.0.0.48].[contractapp2].[dbo].Phone p on p.Profile_ID = pp.Profile_ID left join [10.0.0.48].[contractapp2].[dbo].Email e on e.Profile_ID = pp.Profile_ID left join [10.0.0.48].[contractapp2].[dbo].Profile_Address pa on pa.Profile_ID = pp.Profile_ID where pp.Profile_ID ='" + profile_ID + "'", cs2);
                    // scd.Parameters.Add("@Fracid", SqlDbType.VarChar).Value = Fracid;
                    rowsaffected = scd.ExecuteNonQuery();
                }
                ...
                if (ps == 1)
                {
                    using (SqlConnection cs3 = Queries.GetDBConnection())
                    {
                        SqlCommand SqlCmd = new SqlCommand("select VP_Salu_ID from Salutations where office='" + office + "' and Salutation='" + stitle + "' and Status='Active'", cs3);
                        sendval = (int)SqlCmd.ExecuteScalar();
                    }

                    SqlCommand scd = new SqlCommand("insert into VP_POST_Account select '','','','','','','', psa.Profile_Secondary_Title,'" + sendval + "',psa.Profile_Secondary_Fname,psa.Profile_Secondary_Lname,e.Secondary_Email,p.Secondary_CC+' '+p.Secondary_Mobile,p.Secondary_Alt_CC+' '+p.Secondary_Alternate,pa.Profile_Address_Line1,'','','',pa.Profile_Address_Country,'',psa.Profile_Secondary_Nationality,psa.Profile_Secondary_DOB,'0','0','1','0',psa.Profile_ID,'Secondary','','0','' from [10.0.0.48].[contractapp2].[dbo].Profile_Secondary psa left join [10.0.0.48].[contractapp2].[dbo].Phone p on p.Profile_ID = psa.Profile_ID left join [10.0.0.48].[contractapp2].[dbo].Email e on e.Profile_ID = psa.Profile_ID left join [10.0.0.48].[contractapp2].[dbo].Profile_Address pa on pa.Profile_ID = psa.Profile_ID where psa.Profile_ID= '" + profile_ID + "'", cs2);
                    // scd.Parameters.Add("@Fracid", SqlDbType.VarChar).Value = Fracid;
                    rowsaffected = scd.ExecuteNonQuery();
                }
                ...
                if (sp1 == 1)
                {
                    using (SqlConnection cs3 = Queries.GetDBConnection())
                    {
                        SqlCommand SqlCmd = new SqlCommand("select VP_Salu_ID from Salutations where office='" + office + "' and Salutation='" + sp1title + "' and Status='Active'", cs3);
                        sendval = (int)SqlCmd.ExecuteScalar();
                    }

                    SqlCommand scd = new SqlCommand("insert into VP_POST_Account select '','','','','','','', sp1.Sub_Profile1_Title,'" + sendval + "',sp1.Sub_Profile1_Fname,sp1.Sub_Profile1_Lname,e.Subprofile1_Email,p.Subprofile1_CC+' '+p.Subprofile1_Mobile,p.Subprofile1_Alt_CC+' '+p.Subprofile1_Alternate,pa.Profile_Address_Line1,'','','',pa.Profile_Address_Country,'',sp1.Sub_Profile1_Nationality,sp1.Sub_Profile1_DOB,'0','0','1','0',sp1.Profile_ID,'Sp1','','0','' from [10.0.0.48].[contractapp2].[dbo].Sub_Profile1 sp1 left join [10.0.0.48].[contractapp2].[dbo].Phone p on p.Profile_ID = sp1.Profile_ID left join [10.0.0.48].[contractapp2].[dbo].Email e on e.Profile_ID = sp1.Profile_ID left join [10.0.0.48].[contractapp2].[dbo].Profile_Address pa on pa.Profile_ID = sp1.Profile_ID where sp1.Profile_ID='" + profile_ID + "'", cs2);
                    // scd.Parameters.Add("@Fracid", SqlDbType.VarChar).Value = Fracid;
                    rowsaffected = scd.ExecuteNonQuery();
                }
                ...
                if (sp2 == 1)
                {
                    using (SqlConnection cs3 = Queries.GetDBConnection())
                    {
                        SqlCommand SqlCmd = new SqlCommand("select VP_Salu_ID from Salutations where office='" + office + "' and Salutation='" + sp2title + "' and Status='Active'", cs3);
                        sendval = (int)SqlCmd.ExecuteScalar();
                    }

                    SqlCommand scd = new SqlCommand("insert into VP_POST_Account select '','','','','','','', sp2.Sub_Profile2_Title,'" + sendval + "',sp2.Sub_Profile2_Fname,sp2.Sub_Profile2_Lname,e.Subprofile2_Email,p.Subprofile2_CC+' '+p.Subprofile2_Mobile, p.Subprofile2_Alt_CC+' '+p.Subprofile2_Alternate,pa.Profile_Address_Line1,'','','',pa.Profile_Address_Country,'',sp2.Sub_Profile2_Nationality,sp2.Sub_Profile2_DOB,'0','0','1','0',sp2.Profile_ID,'Sp2','','0','' from [10.0.0.48].[contractapp2].[dbo].Sub_Profile2 sp2 left join [10.0.0.48].[contractapp2].[dbo].Phone p on p.Profile_ID = sp2.Profile_ID left join [10.0.0.48].[contractapp2].[dbo].Email e on e.Profile_ID = sp2.Profile_ID left join [10.0.0.48].[contractapp2].[dbo].Profile_Address pa on pa.Profile_ID = sp2.Profile_ID where sp2.Profile_ID='" + profile_ID + "'", cs2);
                    // scd.Parameters.Add("@Fracid", SqlDbType.VarChar).Value = Fracid;
                    rowsaffected = scd.ExecuteNonQuery();
                }
                ...
                if (sp3 == 1)
                {
                    using (SqlConnection cs3 = Queries.GetDBConnection())
                    {
                        SqlCommand SqlCmd = new SqlCommand("select VP_Salu_ID from Salutations where office='" + office + "' and Salutation='" + sp3title + "' and Status='Active'", cs3);
                        sendval = (int)SqlCmd.ExecuteScalar();
                    }

                    SqlCommand scd = new SqlCommand("insert into VP_POST_Account select '','','','','','','', sp3.Sub_Profile3_Title,'" + sendval + "',sp3.Sub_Profile3_Fname,sp3.Sub_Profile3_Lname,e.Subprofile3_Email,p.Subprofile3_CC+' '+p.Subprofile3_Mobile, p.Subprofile3_Alt_CC+' '+p.Subprofile3_Alternate,pa.Profile_Address_Line1,'','','',pa.Profile_Address_Country,'',sp3.Sub_Profile3_Nationality,sp3.Sub_Profile3_DOB,'0','0','1','0',sp3.Profile_ID,'Sp3','','0','' from [10.0.0.48].[contractapp2].[dbo].Sub_Profile3 sp3 left join [10.0.0.48].[contractapp2].[dbo].Phone p on p.Profile_ID = sp3.Profile_ID left join [10.0.0.48].[contractapp2].[dbo].Email e on e.Profile_ID = sp3.Profile_ID left join [10.0.0.48].[contractapp2].[dbo].Profile_Address pa on pa.Profile_ID = sp3.Profile_ID where sp3.Profile_ID= '" + profile_ID + "'", cs2);
                    // scd.Parameters.Add("@Fracid", SqlDbType.VarChar).Value = Fracid;
                    rowsaffected = scd.ExecuteNonQuery();
                }
                ...
                if (sp4 == 1)
                {
                    using (SqlConnection cs3 = Queries.GetDBConnection())
                    {
                        SqlCommand SqlCmd = new SqlCommand("select VP_Salu_ID from Salutations where office='" + office + "' and Salutation='" + sp4title + "' and Status='Active'", cs3);
                        sendval = (int)SqlCmd.ExecuteScalar();
                    }

                    SqlCommand scd = new SqlCommand("insert into VP_POST_Account select '','','','','','','', sp4.Sub_Profile4_Title,'" + sendval + "',sp4.Sub_Profile4_Fname,sp4.Sub_Profile4_Lname,e.Subprofile4_Email,p.Subprofile4_CC+' '+p.Subprofile4_Mobile, p.Subprofile4_Alt_CC+' '+p.Subprofile4_Alternate,pa.Profile_Address_Line1,'','','',pa.Profile_Address_Country,'',sp4.Sub_Profile4_Nationality,sp4.Sub_Profile4_DOB,'0','0','1','0',sp4.Profile_ID,'Sp4','','0','' from [10.0.0.48].[contractapp2].[dbo].Sub_Profile4 sp4 left join [10.0.0.48].[contractapp2].[dbo].Phone p on p.Profile_ID = sp4.Profile_ID left join [10.0.0.48].[contractapp2].[dbo].Email e on e.Profile_ID = sp4.Profile_ID left join [10.0.0.48].[contractapp2].[dbo].Profile_Address pa on pa.Profile_ID = sp4.Profile_ID where sp4.Profile_ID= '" + profile_ID + "'", cs2);
                    // scd.Parameters.Add("@Fracid", SqlDbType.VarChar).Value = Fracid;
                    rowsaffected = scd.ExecuteNonQuery();
                }
            ...
            catch (Exception ex)
            {
                ...
                string msg = "Error in InsertIntoVPNPost Query FN: InsertIntoVPNPost" + " " + ex.Message;
    ...
    public static int InsertParshuramFDetails(string PFDetails_ID, string PFDetails_IGST_Rate, string PFDetails_Interest_Rate, string PFDetails_Doccu_Fees, string PFDetails_IGST_Amount, string PFDetails_No_Of_EMI, string PFDetails_EMI_Install, string PFDetails_Finance_Month, string Contract_Finance_ID, string Profile_ID, string PFDetails_Insert_Date, string PFDetails_Principle_amt)
    {
        int rowsAffected = 0;
        int id = 0;
        ...
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            try
            {
                da.InsertCommand = new SqlCommand("insert into Parshuram_Finance_Details values(@PFDetails_ID ,	@PFDetails_IGST_Rate ,	@PFDetails_Interest_Rate ,	@PFDetails_Doccu_Fees ,	@PFDetails_IGST_Amount ,	@PFDetails_No_Of_EMI ,	@PFDetails_EMI_Install ,	@PFDetails_Finance_Month ,	@Contract_Finance_ID  ,	@Profile_ID ,	@PFDetails_Insert_Date,@PFDetails_Principle_amt)", cs1);
                da.InsertCommand.Parameters.Add("@PFDetails_ID", SqlDbType.VarChar).Value = PFDetails_ID;
                da.InsertCommand.Parameters.Add("@PFDetails_IGST_Rate", SqlDbType.VarChar).Value = PFDetails_IGST_Rate;
                da.InsertCommand.Parameters.Add("@PFDetails_Interest_Rate", SqlDbType.VarChar).Value = PFDetails_Interest_Rate;
                da.InsertCommand.Parameters.Add("@PFDetails_Doccu_Fees", SqlDbType.VarChar).Value = PFDetails_Doccu_Fees;
                da.InsertCommand.Parameters.Add("@PFDetails_IGST_Amount", SqlDbType.VarChar).Value = PFDetails_IGST_Amount;
                da.InsertCommand.Parameters.Add("@PFDetails_No_Of_EMI", SqlDbType.VarChar).Value = PFDetails_No_Of_EMI;
                da.InsertCommand.Parameters.Add("@PFDetails_EMI_Install", SqlDbType.VarChar).Value = PFDetails_EMI_Install;
                da.InsertCommand.Parameters.Add("@PFDetails_Finance_Month", SqlDbType.VarChar).Value = PFDetails_Finance_Month;
                da.InsertCommand.Parameters.Add("@Profile_ID", SqlDbType.VarChar).Value = Profile_ID;
                da.InsertCommand.Parameters.Add("@Contract_Finance_ID", SqlDbType.VarChar).Value = Contract_Finance_ID;
                da.InsertCommand.Parameters.Add("@PFDetails_Insert_Date", SqlDbType.VarChar).Value = PFDetails_Insert_Date;
                da.InsertCommand.Parameters.Add("@PFDetails_Principle_amt", SqlDbType.VarChar).Value = PFDetails_Principle_amt;
                //   da.InsertCommand.Parameters.Add("@Finance_Details_Monthly_Repay2", SqlDbType.VarChar).Value = Finance_Details_Monthly_Repay2;
                //  da.InsertCommand.Parameters.Add("@Finance_Details_Monthly_RepayProtect", SqlDbType.VarChar).Value = Finance_Details_Monthly_RepayProtect;
                //   da.InsertCommand.Parameters.Add("@Finance_Details_PayProtect", SqlDbType.VarChar).Value = Finance_Details_PayProtect;
                //   da.InsertCommand.Parameters.Add("@Finance_Details_Finance_Date", SqlDbType.VarChar).Value = Finance_Details_Finance_Date;
    ...
    public static int Update_Parshu_Finance_Details(string IGSTRate, string IntRate, string DoccuFees, string IGSTAmt, string NoEMI, string EMIAmt, string Finamonth, string Fracid, string princiamount)
    {
        int rowsAffected = 0;
        //int incr1, id, incr3;
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            try
            {
                ...
                SqlCommand SqlCmd6 = new SqlCommand("update Parshuram_Finance_Details set PFDetails_IGST_Rate='" + IGSTRate + "' ,	PFDetails_Doccu_Fees='" + DoccuFees + "',	PFDetails_IGST_Amount='" + IGSTAmt + "' ,	PFDetails_No_Of_EMI='" + NoEMI + "',	PFDetails_EMI_Install='" + EMIAmt + "',	PFDetails_Finance_Month='" + Finamonth + "' ,	PFDetails_Principle_amt='" + princiamount + "'  where Contract_Finance_ID=@Fracid", cs1);
...
public static DataTable flybuygoa(string date, string venue)
    {

        using (SqlConnection cs1 = Queries.GetDBConnection())
        {

            SqlCommand cmd_sp = new SqlCommand("flybuygoa", cs1);
            cmd_sp.CommandType = CommandType.StoredProcedure;
            cmd_sp.Parameters.AddWithValue("@input", date);
            cmd_sp.Parameters.AddWithValue("@venue", venue);
            SqlDataAdapter da = new SqlDataAdapter();
    ...
    public static DataTable flybuygoaconso(string date)
    {

        using (SqlConnection cs1 = Queries.GetDBConnection())
        {

            SqlCommand cmd_sp = new SqlCommand("flybuygoaconso", cs1);
            cmd_sp.CommandType = CommandType.StoredProcedure;
            cmd_sp.Parameters.AddWithValue("@input", date);
            //cmd_sp.Parameters.AddWithValue("@gvenue", gvenue);
    ...
    public static string getcountryfromnationality(string na)
    {
        string ch;
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            SqlCommand sqcmd = new SqlCommand("select Nationality_Country_Name from Nationality where Nationality_Name=rtrim(ltrim('" + na + "'))", cs1);
            //sqcmd.Parameters.Add("@email", SqlDbType.VarChar).Value = data;
            ch = (string)sqcmd.ExecuteScalar();
    ...
    public static int Insertapidatatest(string ResortID, string BookingNo, string ResortName, string FirstName, string LastName, string BookingSourceCode, string Nationality, string Email, string AddrCountry, string Phone, string DateOfBirth, string Arrival, string Departure)
    {
        int rowsAffected = 0;
        //int rowsAffected2 = 0;
        int id = 0;
        ...
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            try
            {
                ...
                da.InsertCommand = new SqlCommand("insert into apidatatest values(@ResortID,	@BookingNo ,	@ResortName ,	@FirstName,	@LastName ,	@BookingSourceCode, @Nationality, @Email, @AddrCountry, convert(int,@Phone),@DateOfBirth, @Arrival,@Departure)", cs1);
                da.InsertCommand.Parameters.Add("@ResortID", SqlDbType.VarChar).Value = ResortID;
                da.InsertCommand.Parameters.Add("@BookingNo", SqlDbType.VarChar).Value = BookingNo;
                da.InsertCommand.Parameters.Add("@ResortName", SqlDbType.VarChar).Value = ResortName;
                ...
                da.InsertCommand.Parameters.Add("@BookingSourceCode", SqlDbType.VarChar).Value = BookingSourceCode;
                da.InsertCommand.Parameters.Add("@Nationality", SqlDbType.VarChar).Value = Nationality;
                da.InsertCommand.Parameters.Add("@Email", SqlDbType.VarChar).Value = Email;
                da.InsertCommand.Parameters.Add("@AddrCountry", SqlDbType.VarChar).Value = AddrCountry;
                da.InsertCommand.Parameters.Add("@Phone", SqlDbType.VarChar).Value = Phone;
                da.InsertCommand.Parameters.Add("@DateOfBirth", SqlDbType.VarChar).Value = DateOfBirth;
                da.InsertCommand.Parameters.Add("@Arrival", SqlDbType.VarChar).Value = Arrival;
                da.InsertCommand.Parameters.Add("@Departure", SqlDbType.VarChar).Value = Departure;
    ...
    public static DataTable loadregcardAPI()
    {

        using (SqlConnection cs1 = Queries.GetDBConnection())
        {

            SqlCommand cmd_sp = new SqlCommand("GetGuestRegAPI", cs1);
            // cmd.CommandText = "holiday_confirm";
            cmd_sp.CommandType = CommandType.StoredProcedure;
            // cmd_sp.Parameters.AddWithValue("@Profile_Id", Profile_Id);
            // using (SqlCommand cmd = new SqlCommand())
    ...
    public static int Deleteapi()
    {
...

        {
            try
            {
                ...
                SqlCommand scd = new SqlCommand("delete from apidatatest", cs2);
                //scd.Parameters.Add("@ProfileID", SqlDbType.VarChar).Value = ProfileID;
                rowsaffected = scd.ExecuteNonQuery();
    ...
    public static string getRecieptNo(string Office)
    {
        ...
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            ...
            SqlCommand scmd = new SqlCommand("select startv+'/'+FinaYear start from DepositRecieptNo where Office=@Office", cs1);
            scmd.Parameters.Add("@Office", SqlDbType.VarChar).Value = Office;
            startval = (string)scmd.ExecuteScalar();

            SqlCommand scmd1 = new SqlCommand("select IncrV from DepositRecieptNo where Office=@Office", cs1);
            scmd1.Parameters.Add("@Office", SqlDbType.VarChar).Value = Office;
            int val = (int)scmd1.ExecuteScalar();

            id = Convert.ToInt32(val) + 1;

            contfinaid = "SGA/" + startval + "/" + id;
    ...
    public static int InsertDepositRecieptDetails(string Reciept_Inv_Num, string Reciept_Product_Name, string Reciept_Deposit_Amt, string Reciept_Deposit_Amt_NoTax, string Reciept_Rate, string Reciept_SCGST_Amount, string Reciept_GST_Amount, string Reciept_Pay_Method, string Contract_Finance_ID, string Office, DateTime Reciept_Insert_Date)
    {
        int rowsAffected = 0;
        int id = 0;
        ...
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            try
            {
                da.InsertCommand = new SqlCommand("insert into Deposit_Reciept values(@Reciept_Inv_Num ,	@Reciept_Product_Name ,	@Reciept_Deposit_Amt ,	@Reciept_Deposit_Amt_NoTax ,	@Reciept_Rate ,	@Reciept_SCGST_Amount ,	@Reciept_GST_Amount ,	@Reciept_Pay_Method ,	@Contract_Finance_ID ,@Reciept_Insert_Date)", cs1);
                da.InsertCommand.Parameters.Add("@Reciept_Inv_Num", SqlDbType.VarChar).Value = Reciept_Inv_Num;
                da.InsertCommand.Parameters.Add("@Reciept_Product_Name", SqlDbType.VarChar).Value = Reciept_Product_Name;
                da.InsertCommand.Parameters.Add("@Reciept_Deposit_Amt", SqlDbType.VarChar).Value = Reciept_Deposit_Amt;
                da.InsertCommand.Parameters.Add("@Reciept_Deposit_Amt_NoTax", SqlDbType.VarChar).Value = Reciept_Deposit_Amt_NoTax;
                da.InsertCommand.Parameters.Add("@Reciept_Rate", SqlDbType.VarChar).Value = Reciept_Rate;
                da.InsertCommand.Parameters.Add("@Reciept_SCGST_Amount", SqlDbType.VarChar).Value = Reciept_SCGST_Amount;
                da.InsertCommand.Parameters.Add("@Reciept_GST_Amount", SqlDbType.VarChar).Value = Reciept_GST_Amount;
                da.InsertCommand.Parameters.Add("@Reciept_Pay_Method", SqlDbType.VarChar).Value = Reciept_Pay_Method;
                da.InsertCommand.Parameters.Add("@Contract_Finance_ID", SqlDbType.VarChar).Value = Contract_Finance_ID;
                da.InsertCommand.Parameters.Add("@Reciept_Insert_Date", SqlDbType.DateTime).Value = Reciept_Insert_Date;
                //da.InsertCommand.Parameters.Add("@Contract_Finance_ID", SqlDbType.VarChar).Value = Contract_Finance_ID;
                // da.InsertCommand.Parameters.Add("@PFDetails_Insert_Date", SqlDbType.VarChar).Value = PFDetails_Insert_Date;
                // da.InsertCommand.Parameters.Add("@PFDetails_Principle_amt", SqlDbType.VarChar).Value = PFDetails_Principle_amt;
                //   da.InsertCommand.Parameters.Add("@Finance_Details_Monthly_Repay2", SqlDbType.VarChar).Value = Finance_Details_Monthly_Repay2;
                ...
                id = Convert.ToInt32(val) + 1;
                // update Finance_Details_ID set FD_End_Val = '"+id+"'
                SqlCommand scmd2 = new SqlCommand("update DepositRecieptNo set IncrV = '" + id + "' where Office=@Office", cs1);
                scmd2.Parameters.Add("@Office", SqlDbType.VarChar).Value = Office;
                //scmd2.Parameters.Add("@midval", SqlDbType.VarChar).Value = office;
                int rows = scmd2.ExecuteNonQuery();
            }
            catch (Exception ex)
            {
                ...
                string msg = "Error in insert Finance details Query FN: InsertDepositRecieptDetails " + " " + ex.Message;
    ...
    public static int Update_DepositRecieptDetails(string Reciept_Deposit_Amt, string Reciept_Deposit_Amt_NoTax, string Reciept_SCGST_Amount, string Reciept_GST_Amount, string Reciept_Pay_Method, string Contract_Finance_ID)
    {
        int rowsAffected = 0;
        //int incr1, id, incr3;
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            try
            {
                ...
                SqlCommand SqlCmd6 = new SqlCommand("update Deposit_Reciept set Reciept_Deposit_Amt='" + Reciept_Deposit_Amt + "' ,	Reciept_Deposit_Amt_NoTax='" + Reciept_Deposit_Amt_NoTax + "',	Reciept_SCGST_Amount='" + Reciept_SCGST_Amount + "' ,	Reciept_GST_Amount='" + Reciept_GST_Amount + "',	Reciept_Pay_Method='" + Reciept_Pay_Method + "' where Contract_Finance_ID=@Fracid", cs1);

                SqlCmd6.Parameters.Add("@Fracid", SqlDbType.VarChar).Value = Contract_Finance_ID;
                int rows = SqlCmd6.ExecuteNonQuery();
            }
            catch (Exception ex)
            {
                ...
                string msg = "Error in Update Update_DepositRecieptDetails Query FN: Update_Finance_Details" + " " + ex.Message;
    ...
    public static string PnumbCountINR(string midval, string venue2)
    {
        ...
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            if (midval == "IVO" || midval == "VTM" || midval == "GER" || midval == "GRE" || midval == "ITA" || midval == "IRE" || midval == "FRA")
            {
                SqlCommand scmd = new SqlCommand("select Pnum_StartVal from PnumberCountINR where Pnum_Office=@midval", cs1);
                scmd.Parameters.Add("@midval", SqlDbType.VarChar).Value = midval;
                startval = (string)scmd.ExecuteScalar();



                SqlCommand scmd1 = new SqlCommand("select Pnum_EndVal from PnumberCountINR where Pnum_Office=@midval", cs1);
                scmd1.Parameters.Add("@midval", SqlDbType.VarChar).Value = midval;
                int val = (int)scmd1.ExecuteScalar();
            ...
            {
                if (venue2 == "KARMA CHANG -CHANG MAI" || venue2 == "KR BELLA VISTA -CHANG MAI")
                {

                    SqlCommand scmd = new SqlCommand("select Pnum_StartVal from PnumberCountINR where Pnum_Office=@midval and Pnum_Gvenue='KARMA CHANG - CHANG MAI'", cs1);
                    scmd.Parameters.Add("@midval", SqlDbType.VarChar).Value = midval;
                    startval = (string)scmd.ExecuteScalar();



                    SqlCommand scmd1 = new SqlCommand("select Pnum_EndVal from PnumberCountINR where Pnum_Office=@midval and Pnum_Gvenue='KARMA CHANG - CHANG MAI'", cs1);
                    scmd1.Parameters.Add("@midval", SqlDbType.VarChar).Value = midval;
                    int val = (int)scmd1.ExecuteScalar();
                ...
                {
                    SqlCommand scmd = new SqlCommand("select Pnum_StartVal from PnumberCountINR where Pnum_Office=@midval and Pnum_Gvenue='KR BOAT LAGOON - PHUKET'", cs1);
                    scmd.Parameters.Add("@midval", SqlDbType.VarChar).Value = midval;
                    startval = (string)scmd.ExecuteScalar();



                    SqlCommand scmd1 = new SqlCommand("select Pnum_EndVal from PnumberCountINR where Pnum_Office=@midval and Pnum_Gvenue='KR BOAT LAGOON - PHUKET'", cs1);
                    scmd1.Parameters.Add("@midval", SqlDbType.VarChar).Value = midval;
                    int val = (int)scmd1.ExecuteScalar();
    ...
    public static int UpdatePnumberINR(string midval, string venue2)
    {
        int rows = 0;
        int id = 0;
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            try
            {
                ...
                if (midval == "IVO" || midval == "VTM")
                {
                    ...
                    SqlCommand sqlcmd = new SqlCommand("update PnumberCountINR set Pnum_EndVal = '" + id + "' where Pnum_Office=@midval", cs1);
                    sqlcmd.Parameters.Add("@midval", SqlDbType.VarChar).Value = midval;
                    rows = sqlcmd.ExecuteNonQuery();
                }
                else if (midval == "THL")
                {
                    if (venue2 == "KARMA CHANG -CHANG MAI" || venue2 == "KR BELLA VISTA -CHANG MAI")
                    {
                        ...
                        SqlCommand sqlcmd = new SqlCommand("update PnumberCountINR set Pnum_EndVal = '" + id + "' where Pnum_Office=@midval and Pnum_Gvenue='KARMA CHANG - CHANG MAI'", cs1);
                        sqlcmd.Parameters.Add("@midval", SqlDbType.VarChar).Value = midval;
                        rows = sqlcmd.ExecuteNonQuery();
                    ...
                    else
                    {
                        ...
                        SqlCommand sqlcmd = new SqlCommand("update PnumberCountINR set Pnum_EndVal = '" + id + "' where Pnum_Office=@midval and Pnum_Gvenue='KR BOAT LAGOON - PHUKET'", cs1);
                        sqlcmd.Parameters.Add("@midval", SqlDbType.VarChar).Value = midval;
                        rows = sqlcmd.ExecuteNonQuery();
    ...
    public static int InsertVPPostContract(string contractno)
    {
        int rowsAffected = 0;
        int id = 0;
        ...
        using (SqlConnection cs2 = Queries2.GetDBConnection2())
        {
            try
            {
                da.InsertCommand = new SqlCommand("insert into ContractPost select '',p.VP_ID ,cf.Contract_Finance_Cont_Numb,case when cf.Contract_Finance_Cont_Type='Points' then cp.CT_Points_Noof_Points when cf.Contract_Finance_Cont_Type='Trade Into Points' then ctp.TP_Total_Points else '0' end as total_points, case when cf.Contract_Finance_Cont_Type='Points' then 'POINTS' when cf.Contract_Finance_Cont_Type='Trade Into Points' then 'POINTS' when cf.Contract_Finance_Cont_Type='Fractional' then 'WEEKS' when cf.Contract_Finance_Cont_Type='Trade Into Fractional' then 'WEEKS' end as Contract_Finance_Cont_Type  ,case when cf.Contract_Finance_Cont_Type='Fractional' then '14' when cf.Contract_Finance_Cont_Type='Trade Into Fractional' then '14' else '0' end as Unittypeid,'1' weektypeid,convert(date,cf.Contract_finance_Insert_Date) as purchasedate,case when cf.Contract_Finance_Cont_Type='Points' then convert(date,convert(varchar,cp.CT_Points_LYear_Occ)+'-12-31')  when cf.Contract_Finance_Cont_Type='Trade Into Points' then CONVERT(date,convert(varchar,ctp.TP_LY_Occu)+'-12-31') when cf.Contract_Finance_Cont_Type='Fractional' then CONVERT(date,convert(varchar,cff.Contract_Fractional_Last_Occu)+'-12-31') when cf.Contract_Finance_Cont_Type='Trade Into Fractional' then CONVERT(date,convert(varchar,ctf.TF_Last_Occ)+'-12-31') end as 'ExpiryDate','34846','569','34850',case when cf.Contract_Finance_Cont_Type='Points' then cp.CT_Points_Duration  when cf.Contract_Finance_Cont_Type='Trade Into Points' then ctp.TP_Duration when cf.Contract_Finance_Cont_Type='Fractional' then cff.Contract_Fractional_Duration when cf.Contract_Finance_Cont_Type='Trade Into Fractional' then ctf.TF_Duration end as 'Term',case when cf.Contract_Finance_Cont_Type='Trade Into Points' then ctp.TP_New_No_Points else '0' end as TradeIn,'1','2',case when cf.Contract_Finance_Cont_Type='Points' then convert(date,convert(varchar,cp.CT_Points_FYear_Occ)+'-01-01')  when cf.Contract_Finance_Cont_Type='Trade Into Points' then CONVERT(date,convert(varchar,ctp.TP_FY_Occu)+'-01-01') when cf.Contract_Finance_Cont_Type='Fractional' then CONVERT(date,convert(varchar,cff.Contract_Fractional_First_Occu)+'-01-01') when cf.Contract_Finance_Cont_Type='Trade Into Fractional' then CONVERT(date,convert(varchar,ctf.TF_First_Occ)+'-01-01') end as 'Commencedate' ,'0','0','524','0','0','','','vp121','' from [10.0.0.48].[contractapp2].[dbo].Contract_Finance cf  left join [10.0.0.48].[contractapp2].[dbo].CT_Points cp on cp.Contract_Finance_ID = cf.Contract_Finance_ID  left join [10.0.0.48].[contractapp2].[dbo].Contract_TP ctp on ctp.Contract_Finance_ID = cf.Contract_Finance_ID  left join [10.0.0.48].[contractapp2].[dbo].Contract_Fractional cff on cf.Contract_Finance_ID=cff.Contract_Finance_ID  left join [10.0.0.48].[contractapp2].[dbo].Contract_TF ctf on cf.Contract_Finance_ID = ctf.Contract_Finance_ID  left join [10.0.0.48].[contractapp2].[dbo].profile p on p.Profile_ID = cf.Profile_ID where cf.Contract_Finance_Cont_Numb=@contractno", cs2);
                da.InsertCommand.Parameters.Add("@contractno", SqlDbType.VarChar).Value = contractno;
    ...
    public static int checkifVPIDexist(string ProfileID)
    {
        ...
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            ...
            SqlCommand scd = new SqlCommand("select VP_ID from Profile where Profile_ID=@ProfileID", cs1);
            scd.Parameters.Add("@ProfileID", SqlDbType.VarChar).Value = ProfileID;

            //int cnt = (int)scd.ExecuteScalar();
            ch = (string)scd.ExecuteScalar();
            //Pnumbnumb = cnt;
            if (ch != "")
            {
                Pnumbnumb = 1;
    ...
    public static int getweekno2(string date)
    {
        ...
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            try
            {
                ...
                SqlCommand scd = new SqlCommand("select Weekn from defaultweeknumber where Date=convert(date,convert(Datetime,date,105))", cs1);
                scd.Parameters.Add("@date", SqlDbType.VarChar).Value = date;

                //int cnt = (int)scd.ExecuteScalar();
                //ch = (string)scd.ExecuteScalar();
                id = (double)scd.ExecuteScalar();
                Pnumbnumb = Convert.ToInt32(id);
            }
            catch (Exception ex)
            {
    ...
    public static DataSet LoadContractVenueVP(string venuecountry, string cvenue)
    {
        SqlDataAdapter da;
        DataSet ds = new DataSet();
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            ...
            SqlCommand SqlCmd = new SqlCommand("select CVenue_Venue from Contract_Venue_VP where CVenue_VenueCountryID=@venuecountry and CVenue_Venue <>@cvenue", cs1);
            SqlCmd.Parameters.Add("@cvenue", SqlDbType.VarChar).Value = cvenue;
            //SqlCmd.Parameters.Add("@venue", SqlDbType.VarChar).Value = venue;
            SqlCmd.Parameters.Add("@venuecountry", SqlDbType.VarChar).Value = venuecountry;
            da = new SqlDataAdapter(SqlCmd);
            ds = new DataSet();
    ...
    public static DataTable loadQuer1(string startdate, string enddate, string venue, string country, string s_Repname)
    {

        using (SqlConnection cs1 = Queries.GetDBConnection())
        {

            SqlCommand cmd_sp = new SqlCommand("Sales_Manager", cs1);
            ...
            cmd_sp.Parameters.AddWithValue("@venue", venue);
            cmd_sp.Parameters.AddWithValue("@country", country);
            cmd_sp.Parameters.AddWithValue("@manager", s_Repname);
    ...
    public static DataTable loadQuer2(string startdate, string enddate, string venue, string country, string s_Repname)
    {

        using (SqlConnection cs1 = Queries.GetDBConnection())
        {

            SqlCommand cmd_sp = new SqlCommand("Sales_Rep_name", cs1);
            ...
            cmd_sp.Parameters.AddWithValue("@venue", venue);
            cmd_sp.Parameters.AddWithValue("@country", country);
            cmd_sp.Parameters.AddWithValue("@repname", s_Repname);
    ...
    public static DataTable loadQuer3(string startdate, string enddate, string venue, string country, string s_Repname)
    {

        using (SqlConnection cs1 = Queries.GetDBConnection())
        {

            SqlCommand cmd_sp = new SqlCommand("Sales_Rep3", cs1);
    ...
    public static DataTable loadQuer4(string startdate, string enddate)
    {

        using (SqlConnection cs1 = Queries.GetDBConnection())
        {

            SqlCommand cmd_sp = new SqlCommand("DailyRegistered_Deals", cs1);

            cmd_sp.CommandType = CommandType.StoredProcedure;
            cmd_sp.Parameters.AddWithValue("@SDATE", startdate);
            cmd_sp.Parameters.AddWithValue("@EDATE", enddate);
            //cmd_sp.Parameters.AddWithValue("@venue", VENUE);
    ...
    public static DataTable SeapConsoColdFly(string DATE, string COUNTRY)
    {

        using (SqlConnection cs1 = Queries.GetDBConnection())
        {

            SqlCommand cmd_sp = new SqlCommand("SeapconsoFlyCold", cs1);
    ...
    public static DataTable loadQuer5(string date)
    {

        using (SqlConnection cs1 = Queries.GetDBConnection())
        {

            SqlCommand cmd_sp = new SqlCommand("Sales_PromotionByTeam", cs1);
     ...
     public static DataTable ActualBudgetConsolidated(string input,string type)
    {

        using (SqlConnection cs1 = Queries2.GetDBConnection())
        {

            SqlCommand cmd_sp = new SqlCommand("MonthlyBudgetConso", cs1);
            // cmd.CommandText = "holiday_confirm";
            cmd_sp.CommandTimeout = 0;
            cmd_sp.CommandType = CommandType.StoredProcedure;
            cmd_sp.Parameters.AddWithValue("@input", input);
            cmd_sp.Parameters.AddWithValue("@type", type);
     ...
     public static DataTable ActualBudgetYearlyConsolidated(string input,string type)
    {

        using (SqlConnection cs1 = Queries2.GetDBConnection())
        {

            SqlCommand cmd_sp = new SqlCommand("YearlyBudgetConso", cs1);
            // cmd.CommandText = "holiday_confirm";
            cmd_sp.CommandType = CommandType.StoredProcedure;
            cmd_sp.Parameters.AddWithValue("@input", input);
            cmd_sp.Parameters.AddWithValue("@type", type);
    ...
    public static DataTable RawData(string startdate, string enddate, string country)
    {

        using (SqlConnection cs1 = Queries.GetDBConnection())
        {

            SqlCommand cmd_sp = new SqlCommand("RawData", cs1);
    ...
    public static DataTable UserRights(string status)
    {

        using (SqlConnection cs1 = Queries.GetDBConnection())
        {

            SqlCommand cmd_sp = new SqlCommand("UserRights", cs1);
    ...
    public static DataSet LoadSubVenue3(string venue1)
    {
        SqlDataAdapter da;
        DataSet ds = new DataSet();
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            // SqlCommand SqlCmd = new SqlCommand("select SVenue_Name from Sub_Venue where Venue2_ID in (select Venue2_ID from venue2 where Venue2_Name=@venue)", cs1);
            SqlCommand SqlCmd = new SqlCommand("select @venue as SVenue_Name union select 'Member Relation' as SVenue_Name union select 'Odyssey' as SVenue_Name", cs1);
            SqlCmd.Parameters.Add("@venue", SqlDbType.VarChar).Value = venue1;
            da = new SqlDataAdapter(SqlCmd);
            ds = new DataSet();
            da.Fill(ds);
    ...
    public static DataSet CrownFinaCurr1()
    {
        SqlDataAdapter da;
        DataSet dt = new DataSet();
        using (SqlConnection cs1 = Queries.GetDBConnection())
    ...
    public static DataTable InhouseConsolidateEuro(string INPUT, string group)
    {

        using (SqlConnection cs1 = Queries.GetDBConnection())
        {

            SqlCommand cmd_sp = new SqlCommand("EuroInhouseConso", cs1);
    ...
    public static DataTable InhouseConsolidateEuroTs(string INPUT, string group)
    {

        using (SqlConnection cs1 = Queries.GetDBConnection())
        {

            SqlCommand cmd_sp = new SqlCommand("EuroInhouseConsoTS", cs1);
    ...
    public static DataTable loadDSR5(string year, string COUNTRY, string VENUE, string group)
    {

        using (SqlConnection cs1 = Queries.GetDBConnection())
        {

            SqlCommand cmd_sp = new SqlCommand("DSRerate", cs1);
    ...
    public static DataSet LoadCancelType(string CO)
    {
        SqlDataAdapter da;
        DataSet ds = new DataSet();
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            if (CO != "1")
            {
                SqlCommand SqlCmd = new SqlCommand("select CT_Type from Cancel_Type where CT_Status = 'Active' and CT_Type <>'WITHDRAW'", cs1);
                //SqlCmd.Parameters.Add("@office", SqlDbType.VarChar).Value = office; WITHDRAW
                da = new SqlDataAdapter(SqlCmd);
            }
            else
            {
                SqlCommand SqlCmd = new SqlCommand("select CT_Type from Cancel_Type where CT_Status = 'Active' ", cs1);
                //SqlCmd.Parameters.Add("@office", SqlDbType.VarChar).Value = office;
                da = new SqlDataAdapter(SqlCmd);
    ...
    public static DataSet LoadResidenceNo(string resort, string office)
    {
        SqlDataAdapter da;
        DataSet ds = new DataSet();
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            SqlCommand SqlCmd = new SqlCommand("select Contract_Residence_Name from Contract_Residence_No where Contract_Resort_ID in (select Contract_Resort_ID from Contract_Resort where Contract_Resort_Name ='" + resort + "' and office='" + office + "') ", cs1);
            //SqlCmd.Parameters.Add("@ContractType_name", SqlDbType.VarChar).Value = conttype;
            //SqlCmd.Parameters.Add("@Printpdf_office", SqlDbType.VarChar).Value = office;
            da = new SqlDataAdapter(SqlCmd);
            ds = new DataSet();
    ...
    public static string getDealRegisteredDate(string contractno)
    {

        string dealRegisteredDate = null;

        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            SqlCommand scd = new SqlCommand("select case when Contract_Finance_Deal_Reg_Date='1900-01-01' then '' else CONVERT(VARCHAR(10),Contract_Finance_Deal_Reg_Date, 105) end as Contract_Finance_Deal_Reg_Date from Contract_Finance where  Contract_Finance_ID=@contractno", cs1);
            scd.Parameters.Add("@contractno", SqlDbType.VarChar).Value = contractno;

            string cnt = (string)scd.ExecuteScalar();
            dealRegisteredDate = cnt;

        }

        return dealRegisteredDate;
    ...
    public static int Insert_ErrorLog(string Profile_ID, string Contract_ID, string Error_msg, string date)
    {
        int rowsAffected = 0;
        SqlDataAdapter da = new SqlDataAdapter();
        using (SqlConnection cs2 = Queries.GetDBConnection())
        {
            try
            {
                da.InsertCommand = new SqlCommand("insert into ErrorLog values(@Profile_ID,	@Contract_ID,	@Error_msg,CONVERT(Datetime, @date,120))", cs2);
                da.InsertCommand.Parameters.Add("@Profile_ID", SqlDbType.VarChar).Value = Profile_ID;
                da.InsertCommand.Parameters.Add("@Contract_ID", SqlDbType.VarChar).Value = Contract_ID;
                da.InsertCommand.Parameters.Add("@Error_msg", SqlDbType.VarChar).Value = Error_msg;
                da.InsertCommand.Parameters.Add("@date", SqlDbType.VarChar).Value = date;
    ...
    public static string LoadEnDe(string contract_finance_id)
    {
        string sendval1 = "", sendval2 = "";
        string f2;
        //float f1;
        ...
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            SqlCommand SqlCmd = new SqlCommand("select Payment_Details_PCredit_Card_No from Payment_Details where Contract_Finance_ID='" + contract_finance_id + "'", cs1);
            // SqlCmd.Parameters.Add("@Nopoints", SqlDbType.VarChar).Value = NoPoints;

            sendval1 = (string)SqlCmd.ExecuteScalar();

            SqlCommand SqlCmd2 = new SqlCommand("select Payment_Details_PSecurity_No from Payment_Details where Contract_Finance_ID='" + contract_finance_id + "'", cs1);
            //SqlCmd2.Parameters.Add("@Nopoints", SqlDbType.VarChar).Value = NoPoints;

            sendval2 = (string)SqlCmd2.ExecuteScalar();
    ...
    public static  int UpdateEncryptCardDetails ( string contract_no, string cardno, string secuno, string contract_finance_id)
    {
        ...
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            SqlCommand SqlCmd = new SqlCommand("update Payment_Details set Payment_Details_PCredit_Card_No='"+ cardno  + "',Payment_Details_PSecurity_No='"+ secuno + "' where Contract_Finance_ID='" + contract_finance_id + "';update Contract_audit1 set Contract_Process_Date = '" + processDate + "' where Contract_No = '"+ contract_no + "';update  Contract_Finance set Contract_Finance_Process_Date=convert(date,getdate()) where Contract_Finance_ID='"+ contract_finance_id + "'", cs1);
            // SqlCmd.Parameters.Add("@Nopoints", SqlDbType.VarChar).Value = NoPoints;
    ...
    public static DataTable loadQuer5(string date, string venue)
    {
	 ...
	 public static string APIConnect(string contractno,string status)
    {
        string dd = "";
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
           // cs1.Open();
            SqlCommand cmd_sp = new SqlCommand("POST_Account_API", cs1);
            cmd_sp.CommandType = CommandType.StoredProcedure;
            cmd_sp.Parameters.AddWithValue("@Contract", contractno);
		cmd_sp.Parameters.AddWithValue("@Status", status);
            //cmd_sp.Connection.Open();
            cmd_sp.ExecuteNonQuery();
            // cmd_sp.Connection.Close();
           // cs1.Close();
            //return 1;
            dd = "1";
            return dd;
    ...
    public static string getProfileGroupVenuefromNo(string midval)
    {
        ...
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            ...
            // SqlCommand scd = new SqlCommand("select Profile_ID from Contract_Finance where  Contract_Finance_Cont_Numb=@midval", cs1);
            //select Profile_ID from Contract_Finance where  Contract_Finance_Cont_Numb='' union select ProfileID from ContractDetails_Indian where ContractNo=''
            SqlCommand scd = new SqlCommand("select Profile_Group_Venue from Profile where Profile_ID=@midval", cs1);
            scd.Parameters.Add("@midval", SqlDbType.VarChar).Value = midval;
    ...
    public static string getContractTypefromNo(string midval)
    {
        ...
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            ...
            // SqlCommand scd = new SqlCommand("select Profile_ID from Contract_Finance where  Contract_Finance_Cont_Numb=@midval", cs1);
            //select Profile_ID from Contract_Finance where  Contract_Finance_Cont_Numb='' union select ProfileID from ContractDetails_Indian where ContractNo=''
            SqlCommand scd = new SqlCommand("select Contract_Finance_Cont_Type from Contract_Finance where  Contract_Finance_Cont_Numb=@midval union select ContractType from ContractDetails_Indian where ContractNo=@midval", cs1);
            scd.Parameters.Add("@midval", SqlDbType.VarChar).Value = midval;
    ...
    public static int Contract_Audit1Exists(string Contract_No)
    {
        int c = 0;
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {

            SqlCommand scd = new SqlCommand(" select Contract_No  from Contract_Audit1  where Contract_No =@Contract_No", cs1);
            scd.Parameters.Add("@Contract_No", SqlDbType.VarChar).Value = @Contract_No;
            SqlDataReader dr = scd.ExecuteReader();
            if (dr.Read() == true)
            {
                c = 1;
 ...
 public static DataTable RecapFlybuy(string dates, string country)
	{

		using (SqlConnection cs1 = Queries.GetDBConnection())
		{

			SqlCommand cmd_sp = new SqlCommand("RecapFlyConso", cs1);
			cmd_sp.CommandType = CommandType.StoredProcedure;
			cmd_sp.Parameters.AddWithValue("@date", dates);
			cmd_sp.Parameters.AddWithValue("@country", country);
			SqlDataAdapter da = new SqlDataAdapter();
			da.SelectCommand = cmd_sp;
			DataTable datatable = new DataTable();
    ...
    public static DataTable RegionalConsoFlybuy(string dates, string country)
    {

        using (SqlConnection cs1 = Queries.GetDBConnection())
        {

            SqlCommand cmd_sp = new SqlCommand("RegionalConsoFlybuy", cs1);
            cmd_sp.CommandType = CommandType.StoredProcedure;
            cmd_sp.Parameters.AddWithValue("@date", dates);
            cmd_sp.Parameters.AddWithValue("@country", country);
            SqlDataAdapter da = new SqlDataAdapter();
...
public static DataTable Seapdate2(string INPUT)
    {

        using (SqlConnection cs1 = Queries.GetDBConnection())
        {

            SqlCommand cmd_sp = new SqlCommand("seapdate2", cs1);

            cmd_sp.CommandType = CommandType.StoredProcedure;
            cmd_sp.Parameters.AddWithValue("@date", INPUT);
...
public static DataTable Recap_Flybuy_single(string date, string country, string venue)
    {

        using (SqlConnection cs1 = Queries.GetDBConnection())
        {

            SqlCommand cmd_sp = new SqlCommand("RecapFlySingle", cs1);
            // cmd.CommandText = "holiday_confirm";
            cmd_sp.CommandType = CommandType.StoredProcedure;
            cmd_sp.Parameters.AddWithValue("@date", date);
            cmd_sp.Parameters.AddWithValue("@country", country);
...
public static DataTable K2RegionalConso(string dates, string country, string subvenue)
    {

        using (SqlConnection cs1 = Queries.GetDBConnection())
        {

            SqlCommand cmd_sp = new SqlCommand("KE2Regional", cs1);
            cmd_sp.CommandType = CommandType.StoredProcedure;
            cmd_sp.Parameters.AddWithValue("@date", dates);
            cmd_sp.Parameters.AddWithValue("@country", country);
            cmd_sp.Parameters.AddWithValue("@svenue", subvenue);
            SqlDataAdapter da = new SqlDataAdapter();
            da.SelectCommand = cmd_sp;
            DataTable datatable = new DataTable();
            da.Fill(datatable);
 ...
 public static DataTable K2Group(string dates , string subvenue)
    {

        using (SqlConnection cs1 = Queries.GetDBConnection())
        {

            SqlCommand cmd_sp = new SqlCommand("KE2Group", cs1);
            cmd_sp.CommandType = CommandType.StoredProcedure;
            cmd_sp.Parameters.AddWithValue("@date", dates);
            cmd_sp.Parameters.AddWithValue("@svenue", subvenue);
            //cmd_sp.Parameters.AddWithValue("@country", country);
    ...
    public static DataTable GroupConso(string dates)
    {

        using (SqlConnection cs1 = Queries.GetDBConnection())
        {

            SqlCommand cmd_sp = new SqlCommand("GroupConsoRecap", cs1);
            cmd_sp.CommandType = CommandType.StoredProcedure;
            cmd_sp.Parameters.AddWithValue("@date", dates);
            //cmd_sp.Parameters.AddWithValue("@country", country);
            SqlDataAdapter da = new SqlDataAdapter();
 ...
 public static DataTable GroupBudgetConsoMonthly(string dates)
    {

        using (SqlConnection cs1 = Queries.GetDBConnection())
        {

            SqlCommand cmd_sp = new SqlCommand("MonthlyBudgetConsoGroup", cs1);
            cmd_sp.CommandType = CommandType.StoredProcedure;
            cmd_sp.Parameters.AddWithValue("@input", dates);
            //cmd_sp.Parameters.AddWithValue("@country", country);
            SqlDataAdapter da = new SqlDataAdapter();
            da.SelectCommand = cmd_sp;
            DataTable datatable = new DataTable();
 ...
 public static DataTable GroupBudgetConsoYearly(string dates)
    {

        using (SqlConnection cs1 = Queries.GetDBConnection())
        {

            SqlCommand cmd_sp = new SqlCommand("YearlyBudgetConsoGroup", cs1);
            cmd_sp.CommandType = CommandType.StoredProcedure;
            cmd_sp.Parameters.AddWithValue("@input", dates);
            //cmd_sp.Parameters.AddWithValue("@country", country);
            SqlDataAdapter da = new SqlDataAdapter();
...
public static DataTable NewPoint(string startdate, string enddate)
{

using (SqlConnection cs1 = Queries.GetDBConnection())
{

SqlCommand cmd_sp = new SqlCommand("NewPoint", cs1);
...
public static DataTable AccountData(string startdate, string enddate)
{

using (SqlConnection cs1 = Queries.GetDBConnection())
{

SqlCommand cmd_sp = new SqlCommand("AccountData", cs1);
